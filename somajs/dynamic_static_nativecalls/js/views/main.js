(function (todo) {___jdce_logger("/js/views/main.js", 0);
	...
	todo.MainView = function (scope, template, model, router, dispatcher) {___jdce_logger("/js/views/main.js", 1);
		...
		scope.remove = function (event, item) {___jdce_logger("/js/views/main.js", 7);
			if (item) {
		...
		scope.update = function (event, item) {___jdce_logger("/js/views/main.js", 9);
		...
		function cancelEditing(event, item) {___jdce_logger("/js/views/main.js", 10);
