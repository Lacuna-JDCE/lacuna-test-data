...
(function (window, Ractive) {___jdce_logger("/js/app.js", 0);
	...
	var todoList = new Ractive({
		...
		events: (function () {___jdce_logger("/js/app.js", 6);
			var makeCustomEvent = function (keyCode) {___jdce_logger("/js/app.js", 7);
				return function(){___jdce_logger("/js/app.js", 8);};
			};
	...
	todoList.on({
		...
		remove: function(){___jdce_logger("/js/app.js", 9);},

		// The `event` object contains useful properties for (e.g.) retrieving
		// data from the DOM
		newTodo: function(){___jdce_logger("/js/app.js", 10);},

		edit: function(){___jdce_logger("/js/app.js", 11);},

		submit: function(){___jdce_logger("/js/app.js", 12);},

		cancel: function (event) {___jdce_logger("/js/app.js", 13);
			this.set(event.keypath + '.editing', false);
		},

		clearCompleted: function(){___jdce_logger("/js/app.js", 14);},

		toggleAll: function(){___jdce_logger("/js/app.js", 15);}
	});
