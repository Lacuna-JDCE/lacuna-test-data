...
(function () {___jdce_logger("/js/app.js", 0);
	...
	var Todos = App.Collection(Todo, {
		...
		save: function () {___jdce_logger("/js/app.js", 10);
			...
			blocks.each(this(), function (model) {___jdce_logger("/js/app.js", 11);
		...
		updateRemaining: function () {___jdce_logger("/js/app.js", 12);
			this.remaining(this.reduce(function (memo, todo) {___jdce_logger("/js/app.js", 13);
	...
	App.View('Todos', {
		...
		todos: new Todos().extend('filter', function(){___jdce_logger("/js/app.js", 14);}),

		// filter the data when the route have changed
		// the callback is fired when "All", "Active" or "Completed" have been clicked
		routed: function (params) {___jdce_logger("/js/app.js", 15);
		...
		addTodo: function(){___jdce_logger("/js/app.js", 16);}
	});
})();
