...
(function (window) {___jdce_logger("/js/helpers.js", 0);
	...
	window.qsa = function (selector, scope) {___jdce_logger("/js/helpers.js", 2);
	...
	window.$delegate = function (target, selector, type, handler) {___jdce_logger("/js/helpers.js", 4);
		function dispatchEvent(event) {___jdce_logger("/js/helpers.js", 5);
	...
	// $parent(qs('a'), 'div');
	window.$parent = function (element, tagName) {___jdce_logger("/js/helpers.js", 6);
