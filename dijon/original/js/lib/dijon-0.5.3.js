 ...
 */
( function ( scope ) {___jdce_logger("/js/lib/dijon-0.5.3.js", 0);
     ...
     * @constructor
     */
    dijon.System = function () {___jdce_logger("/js/lib/dijon-0.5.3.js", 1);
        /** @private */
        this._mappings = {};
    ...
    dijon.System.prototype = {
         ...
         * @param {Class} clazz
         */
        _createAndSetupInstance:function ( key, Clazz ) {___jdce_logger("/js/lib/dijon-0.5.3.js", 2);
         ...
         * @return {Object}
         */
        _retrieveFromCacheOrCreate:function ( key, overrideRules ) {___jdce_logger("/js/lib/dijon-0.5.3.js", 3);
         ...
         */
        mapOutlet:function ( sourceKey, targetKey, outletName ) {___jdce_logger("/js/lib/dijon-0.5.3.js", 4);
         ...
         * @return {Object}
         */
        getObject:function ( key ) {___jdce_logger("/js/lib/dijon-0.5.3.js", 5);
         ...
         * @return {dijon.System}
         */
        mapValue:function ( key, useValue ) {___jdce_logger("/js/lib/dijon-0.5.3.js", 6);
            if ( typeof key === 'undefined' ) {
         ...
         * @return {Boolean}
         */
        hasMapping:function ( key ) {___jdce_logger("/js/lib/dijon-0.5.3.js", 7);
            if ( typeof key === 'undefined' ) {
         ...
         * @return {dijon.System}
         */
        mapClass:function ( key, clazz ) {___jdce_logger("/js/lib/dijon-0.5.3.js", 8);
            if ( typeof key === 'undefined' ) {
         ...
         * @return {dijon.System}
         */
        mapSingleton:function ( key, clazz ) {___jdce_logger("/js/lib/dijon-0.5.3.js", 9);
            if ( typeof key === 'undefined' ) {
         ...
         * @return {Object}
         */
        instantiate:function ( key ) {___jdce_logger("/js/lib/dijon-0.5.3.js", 10);
            if ( typeof key === 'undefined' ) {
         ...
         * @return {dijon.System}
         */
        injectInto:function ( instance, key ) {___jdce_logger("/js/lib/dijon-0.5.3.js", 11);
         ...
         * @return {dijon.System}
         */
        unmap:function ( key ) {___jdce_logger("/js/lib/dijon-0.5.3.js", 12);
            if ( typeof key === 'undefined' ) {
         ...
         */
        unmapOutlet:function ( target, outlet ) {___jdce_logger("/js/lib/dijon-0.5.3.js", 13);
         ...
         */
        mapHandler:function ( eventName, key, handler, oneShot, passEvent ) {___jdce_logger("/js/lib/dijon-0.5.3.js", 14);
         ...
         */
        unmapHandler:function ( eventName, key, handler ) {___jdce_logger("/js/lib/dijon-0.5.3.js", 15);
            if ( typeof eventName === 'undefined' ) {
         ...
         * @see dijon.System#mapHandler
         */
        notify:function ( eventName ) {___jdce_logger("/js/lib/dijon-0.5.3.js", 16);
            if ( typeof eventName === 'undefined' ) {
