...
puremvc.define({ name: 'todomvc.view.event.AppEvents' }, {},
	// STATIC MEMBERS
	{
		...
		createEvent: function( eventName ) {___jdce_logger("/js/view/event/AppEvents.js", 0);
			var event;
		...
		dispatchEvent: function( object, event ) {___jdce_logger("/js/view/event/AppEvents.js", 2);
