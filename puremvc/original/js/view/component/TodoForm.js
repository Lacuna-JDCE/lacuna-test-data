...
puremvc.define({
		...
		constructor: function(event) {___jdce_logger("/js/view/component/TodoForm.js", 0);
			// data
			this.todos  = [];
			this.stats  = {};
			this.filter = '';
			...
			todomvc.view.event.AppEvents.addEventListener( this.newTodoField, 'keypress', function( event ) {___jdce_logger("/js/view/component/TodoForm.js", 1);
			...
			todomvc.view.event.AppEvents.addEventListener( this.clearButton, 'click', function( event ) {___jdce_logger("/js/view/component/TodoForm.js", 2);
					this.component.dispatchClearCompleted( event );
			});


			this.toggleAllCheckbox.component = this;
			todomvc.view.event.AppEvents.addEventListener( this.toggleAllCheckbox, 'change', function( event ) {___jdce_logger("/js/view/component/TodoForm.js", 3);
	...
	// INSTANCE MEMBERS
	{
			...
			addEventListener: function ( type, listener, useCapture ){___jdce_logger("/js/view/component/TodoForm.js", 4);
				todomvc.view.event.AppEvents.addEventListener ( this.todoApp, type, listener, useCapture );
			},

			createEvent: function( eventName ) {___jdce_logger("/js/view/component/TodoForm.js", 5);
			   return todomvc.view.event.AppEvents.createEvent( eventName );
			},

			dispatchEvent: function( event ) {___jdce_logger("/js/view/component/TodoForm.js", 6);
			   todomvc.view.event.AppEvents.dispatchEvent( this.todoApp, event );
			},

			abandonEditTodo: function( event ) {___jdce_logger("/js/view/component/TodoForm.js", 7);
			...
			dispatchToggleComplete: function( event ) {___jdce_logger("/js/view/component/TodoForm.js", 8);
			...
			dispatchToggleCompleteAll: function( checked ) {___jdce_logger("/js/view/component/TodoForm.js", 9);
			...
			dispatchClearCompleted: function() {___jdce_logger("/js/view/component/TodoForm.js", 10);
			...
			dispatchDelete: function( id ) {___jdce_logger("/js/view/component/TodoForm.js", 11);
			...
			dispatchAddTodo: function( event ) {___jdce_logger("/js/view/component/TodoForm.js", 12);
			...
			dispatchUpdateTodo: function(event) {___jdce_logger("/js/view/component/TodoForm.js", 13);
			...
			setFilteredTodoList: function( data ) {___jdce_logger("/js/view/component/TodoForm.js", 14);
				...
				for ( i=0; i < this.todos.length; i++ ) {
					...
					todomvc.view.event.AppEvents.addEventListener( checkbox, 'change', function( event ) {___jdce_logger("/js/view/component/TodoForm.js", 15);
					...
					todomvc.view.event.AppEvents.addEventListener( deleteLink, 'click', function( event ) {___jdce_logger("/js/view/component/TodoForm.js", 16);
					...
					todomvc.view.event.AppEvents.addEventListener( divDisplay, 'dblclick', function() {___jdce_logger("/js/view/component/TodoForm.js", 17);
					...
					todomvc.view.event.AppEvents.addEventListener( inputEditTodo, 'keypress', function( event ) {___jdce_logger("/js/view/component/TodoForm.js", 18);
						if ( event.keyCode === this.component.ENTER_KEY ) {
							this.component.dispatchUpdateTodo( event );
						}
					});

					todomvc.view.event.AppEvents.addEventListener( inputEditTodo, 'keydown', function( event ) {___jdce_logger("/js/view/component/TodoForm.js", 19);
						if ( event.keyCode === this.component.ESC_KEY ) {
							this.component.abandonEditTodo( event );
						}
					});

					todomvc.view.event.AppEvents.addEventListener( inputEditTodo, 'blur', function( event ) {___jdce_logger("/js/view/component/TodoForm.js", 20);
						this.component.dispatchUpdateTodo( event );
					});
			...
			getTodoById: function( id ) {___jdce_logger("/js/view/component/TodoForm.js", 21);
			   var i;
				for ( i = 0; i < this.todos.length; i++ ) {
			...
			updateFilter: function() {___jdce_logger("/js/view/component/TodoForm.js", 22);
			...
			updateToggleAllCheckbox: function() {___jdce_logger("/js/view/component/TodoForm.js", 23);
			...
			updateClearButton: function() {___jdce_logger("/js/view/component/TodoForm.js", 24);
				this.clearButton.style.display = ( this.stats.todoCompleted === 0 ) ? 'none' : 'block';
				this.clearButton.innerHTML = 'Clear completed';
			},

			updateTodoCount: function() {___jdce_logger("/js/view/component/TodoForm.js", 25);
