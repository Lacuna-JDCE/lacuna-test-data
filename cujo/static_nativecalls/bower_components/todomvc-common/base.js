(function () {___jdce_logger("/bower_components/todomvc-common/base.js", 0);
	...
	if (location.hostname === 'todomvc.com') {
		window._gaq = [['_setAccount','UA-31081062-1'],['_trackPageview']];(function(d,t){___jdce_logger("/bower_components/todomvc-common/base.js", 4);var g=d.createElement(t),s=d.getElementsByTagName(t)[0];g.src='//www.google-analytics.com/ga.js';s.parentNode.insertBefore(g,s)}(document,'script'));
	}
