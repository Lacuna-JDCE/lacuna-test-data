...
(function ($, undefined) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 0);
    ...
    var Binding = Observable.extend( {
        ...
        set: function(value) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 10);
            var that = this,
    ...
    binders.style = Binder.extend({
        refresh: function(key) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 20);
    ...
    binders.source = Binder.extend({
        ...
        add: function(index, items) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 40);
        ...
        remove: function(index, items) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 41);
    ...
    binders.select = {
        value: Binder.extend({
            init: function(target, bindings, options) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 48);
    ...
    binders.widget = {
        events : Binder.extend({
            init: function(widget, bindings, options) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 52);
                Binder.fn.init.call(this, widget.element[0], bindings, options);
                this.widget = widget;
                this.handlers = {};
            },

            refresh: function(key) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 53);
                ...
                this.handlers[key] = function(e) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 54);
            ...
            destroy: function() {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 55);
                var handler;
        ...
        checked: Binder.extend({
            init: function(widget, bindings, options) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 56);
                Binder.fn.init.call(this, widget.element[0], bindings, options);
            ...
            change: function() {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 57);
                this.bindings[CHECKED].set(this.value());
            },

            refresh: function() {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 58);
                this.widget.check(this.bindings[CHECKED].get() === true);
            },

            value: function() {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 59);
                var element = this.element,
                    value = element.value;
            ...
            destroy: function() {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 60);
                this.widget.unbind(CHANGE, this._change);
            }
        }),

        visible: Binder.extend({
            init: function(widget, bindings, options) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 61);
                Binder.fn.init.call(this, widget.element[0], bindings, options);

                this.widget = widget;
            },

            refresh: function() {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 62);
        ...
        invisible: Binder.extend({
            init: function(widget, bindings, options) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 63);
                Binder.fn.init.call(this, widget.element[0], bindings, options);

                this.widget = widget;
            },

            refresh: function() {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 64);
        ...
        enabled: Binder.extend({
            init: function(widget, bindings, options) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 65);
                Binder.fn.init.call(this, widget.element[0], bindings, options);

                this.widget = widget;
            },

            refresh: function() {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 66);
        ...
        disabled: Binder.extend({
            init: function(widget, bindings, options) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 67);
                Binder.fn.init.call(this, widget.element[0], bindings, options);

                this.widget = widget;
            },

            refresh: function() {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 68);
                if (this.widget.enable) {
        ...
        source: Binder.extend({
            init: function(widget, bindings, options) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 69);
                var that = this;
            ...
            itemChange: function(e) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 70);
                bindElement(e.item[0], e.data, this._ns(e.ns), [e.data].concat(this.bindings.source._parents()));
            },

            dataBinding: function() {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 71);
                var idx,
                    length,
                    widget = this.widget,
                    items = widget.items();
            ...
            _ns: function(ns) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 72);
                ns = ns || kendo.ui;
            ...
            dataBound: function(e) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 73);
                var idx,
                    length,
                    widget = this.widget,
                    items = widget.items(),
            ...
            refresh: function(e) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 74);
                var that = this,
                    source,
                    widget = that.widget;
            ...
            destroy: function() {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 75);
        ...
        value: Binder.extend({
            init: function(widget, bindings, options) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 76);
                Binder.fn.init.call(this, widget.element[0], bindings, options);
            ...
            change: function() {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 77);
            ...
            refresh: function() {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 78);
            ...
            destroy: function() {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 79);
                this.widget.unbind(CHANGE, this._change);
            }
        }),
        ...
        multiselect: {
            value: Binder.extend({
                init: function(widget, bindings, options) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 80);
                    Binder.fn.init.call(this, widget.element[0], bindings, options);
                ...
                change: function() {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 81);
                    var that = this,
                ...
                refresh: function() {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 82);
                    if (!this._initChange) {
                        var field = this.options.dataValueField || this.options.dataTextField,
                            value = this.bindings.value.get(),
                            idx = 0, length,
                ...
                destroy: function() {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 83);
                    this.widget.unbind(CHANGE, this._change);
                }
    ...
    var BindingTarget = Class.extend( {
        init: function(target, options) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 84);
            this.target = target;
            this.options = options;
            this.toDestroy = [];
        },

        bind: function(bindings) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 85);
        ...
        applyBinding: function(name, bindings, specificBinders) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 86);
        ...
        destroy: function() {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 87);
            var idx,
                length,
                toDestroy = this.toDestroy;
    ...
    var WidgetBindingTarget = BindingTarget.extend( {
        bind: function(bindings) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 88);
            var that = this,
                binding,
                hasValue = false,
                hasSource = false,
        ...
        applyBinding: function(name, bindings, specificBinder) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 89);
    ...
    function flattenGroups(data) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 90);
    ...
    function bindingTargetForRole(element, roles) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 91);
    ...
    function parseBindings(bind) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 92);
        var result = {},
            idx,
            length,
            token,
    ...
    function createBindings(bindings, source, type) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 93);
        var binding,
            result = {};
    ...
    function bindElement(element, source, roles, parents) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 94);
    ...
    function bind(dom, object) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 95);
        var idx,
            length,
            node,
    ...
    function unbindElement(element) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 96);
    ...
    function unbindElementTree(element) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 97);
        unbindElement(element);

        unbindElementChildren(element);
    }

    function unbindElementChildren(element) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 98);
    ...
    function unbind(dom) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 99);
        var idx, length;
    ...
    function notify(widget, namespace) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 100);
    ...
    kendo.observable = function(object) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 101);
    ...
    kendo.observableHierarchy = function(array) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 102);
        var dataSource = kendo.data.HierarchicalDataSource.create(array);

        function recursiveRead(data) {___jdce_logger("/bower_components/kendo-ui/src/js/kendo.binder.js", 103);
            var i, children;
