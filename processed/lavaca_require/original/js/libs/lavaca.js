...
define('lavaca/util/extend',[],function() {___jdce_logger("/js/libs/lavaca.js", 2);
   ...
   * @return {Function}  The subtype
   */
  var extend = function(TSuper, TSub, overrides) {___jdce_logger("/js/libs/lavaca.js", 3);
    if (typeof TSuper === 'object') {
      overrides = TSuper;
      TSuper = Object;
      TSub = function() {___jdce_logger("/js/libs/lavaca.js", 4);
        // Empty
      };
    ...
    function ctor() {___jdce_logger("/js/libs/lavaca.js", 5);
      // Empty
    }
    ...
    TSub.extend = function(T, overrides) {___jdce_logger("/js/libs/lavaca.js", 6);
      if (typeof T === 'object') {
        overrides = T;
        T = function() {___jdce_logger("/js/libs/lavaca.js", 7);
...
define('lavaca/util/Promise',['require','./extend'],function(require) {___jdce_logger("/js/libs/lavaca.js", 8);
   ...
   */
  var Promise = extend(function(thisp) {___jdce_logger("/js/libs/lavaca.js", 9);
    /**
     ...
     */
    success: function(callback) {___jdce_logger("/js/libs/lavaca.js", 10);
      if (callback) {
        if (this.succeeded) {
     ...
     * @return {Lavaca.util.Promise}  This promise (for chaining)
     */
    error: function(callback) {___jdce_logger("/js/libs/lavaca.js", 11);
      if (callback) {
        if (this.failed) {
     ...
     * @return {Lavaca.util.Promise}  This promise (for chaining)
     */
    always: function(callback) {___jdce_logger("/js/libs/lavaca.js", 12);
     ...
     * @return {Lavaca.util.Promise}  This promise (for chaining)
     */
    then: function(resolved, rejected) {___jdce_logger("/js/libs/lavaca.js", 13);
      return this
        .success(resolved)
        .error(rejected);
    },
     ...
     * @return {Lavaca.util.Promise}  This promise (for chaining)
     */
    resolve: function(/* value1, value2, valueN */) {___jdce_logger("/js/libs/lavaca.js", 14);
     ...
     * @return {Lavaca.util.Promise}  This promise (for chaining)
     */
    reject: function(/* err1, err2, errN */) {___jdce_logger("/js/libs/lavaca.js", 15);
      if (!this.succeeded && !this.failed) {
        this.failed = true;
     ...
     * @return {Lavaca.util.Promise}  This promise (for chaining)
     */
    when: function(/* promise1, promise2, promiseN */) {___jdce_logger("/js/libs/lavaca.js", 16);
      var self = this,
          values = [],
          i = -1,
      ...
      while (!!(promise = arguments[++i])) {
        (function(index) {___jdce_logger("/js/libs/lavaca.js", 17);
          promise
            .success(function(v) {___jdce_logger("/js/libs/lavaca.js", 18);
              values[index] = v;
              if (--pendingPromiseCount < 1) {
                self.resolve.apply(self, values);
              }
            })
            .error(function() {___jdce_logger("/js/libs/lavaca.js", 19);
     ...
     */
    resolver: function() {___jdce_logger("/js/libs/lavaca.js", 20);
      var self = this;
      return function() {___jdce_logger("/js/libs/lavaca.js", 21);
     ...
     * @return {Function}  The callback
     */
    rejector: function() {___jdce_logger("/js/libs/lavaca.js", 22);
      var self = this;
      return function() {___jdce_logger("/js/libs/lavaca.js", 23);
        self.reject.apply(self, arguments);
      };
    }
  });
   ...
   * @return {Lavaca.util.Promise}  The new promise
   */
  Promise.when = function(thisp/*, promise1, promise2, promiseN */) {___jdce_logger("/js/libs/lavaca.js", 24);
...
define('lavaca/env/Device',['require','$','cordova','lavaca/util/Promise'],function(require) {___jdce_logger("/js/libs/lavaca.js", 25);
   ...
   */
  Device.isCordova = function() {___jdce_logger("/js/libs/lavaca.js", 26);
    return !!Cordova;
  };
  /**
   ...
   */
  Device.register = function(name, TPlugin) {___jdce_logger("/js/libs/lavaca.js", 27);
    function install() {___jdce_logger("/js/libs/lavaca.js", 28);
      if (!window.plugins) {
        window.plugins = {};
      }
   ...
   */
  Device.exec = function(className, methodName, args) {___jdce_logger("/js/libs/lavaca.js", 29);
   ...
   */
  Device.init = function(callback) {___jdce_logger("/js/libs/lavaca.js", 30);
    if (!Cordova) {
  ...
  $(document).ready(function() {___jdce_logger("/js/libs/lavaca.js", 31);
    var i = -1,
        installPlugin;
...
define('lavaca/util/Disposable',['require','./extend'],function(require) {___jdce_logger("/js/libs/lavaca.js", 32);

  var extend = require('./extend');

  function _disposeOf(obj) {___jdce_logger("/js/libs/lavaca.js", 33);
    var n,
        o,
        i;
    for (n in obj) {
  ...
  var Disposable = extend({
     ...
     *
     */
    dispose: function() {___jdce_logger("/js/libs/lavaca.js", 34);
        _disposeOf(this);
    }
  });
...
define('mout/object/hasOwn',[],function () {___jdce_logger("/js/libs/lavaca.js", 35);

    /**
     * Safer Object.hasOwnProperty
     */
     function hasOwn(obj, prop){___jdce_logger("/js/libs/lavaca.js", 36);
...
define('mout/object/forIn',[],function () {___jdce_logger("/js/libs/lavaca.js", 37);

    var _hasDontEnumBug,
        _dontEnums;

    function checkDontEnum(){___jdce_logger("/js/libs/lavaca.js", 38);
        _dontEnums = [
                'toString',
                'toLocaleString',
                'valueOf',
     ...
     */
    function forIn(obj, fn, thisObj){___jdce_logger("/js/libs/lavaca.js", 39);
        var key, i = 0;
    ...
    function exec(fn, obj, key, thisObj){___jdce_logger("/js/libs/lavaca.js", 40);
...
define('mout/object/forOwn',['./hasOwn', './forIn'], function (hasOwn, forIn) {___jdce_logger("/js/libs/lavaca.js", 41);
     ...
     * based on: http://whattheheadsaid.com/2010/10/a-safer-object-keys-compatibility-implementation
     */
    function forOwn(obj, fn, thisObj){___jdce_logger("/js/libs/lavaca.js", 42);
        forIn(obj, function(val, key){___jdce_logger("/js/libs/lavaca.js", 43);
            if (hasOwn(obj, key)) {
                return fn.call(thisObj, obj[key], key, obj);
            }
        });
...
define('mout/lang/isPlainObject',[],function () {___jdce_logger("/js/libs/lavaca.js", 44);

    /**
     * Checks if the value is created by the `Object` constructor.
     */
    function isPlainObject(value) {___jdce_logger("/js/libs/lavaca.js", 45);
        return (!!value
            && typeof value === 'object'
...
define('mout/object/deepMixIn',['./forOwn', '../lang/isPlainObject'], function (forOwn, isPlainObject) {___jdce_logger("/js/libs/lavaca.js", 46);

    /**
     * Mixes objects into the target object, recursively mixing existing child
     * objects.
     */
    function deepMixIn(target, objects) {___jdce_logger("/js/libs/lavaca.js", 47);
        var i = 0,
            n = arguments.length,
            obj;
    ...
    function copyProp(val, key) {___jdce_logger("/js/libs/lavaca.js", 48);
...
define('lavaca/events/EventDispatcher',['require','lavaca/util/Disposable','mout/object/deepMixIn'],function(require) {___jdce_logger("/js/libs/lavaca.js", 49);
  ...
  var EventDispatcher = Disposable.extend({
     ...
     * @return {Lavaca.events.EventDispatcher}  This event dispatcher (for chaining)
     */
    on: function(type, callback, thisp) {___jdce_logger("/js/libs/lavaca.js", 50);
     ...
     * @return {Lavaca.events.EventDispatcher}  This event dispatcher (for chaining)
     */
    off: function(type, callback, thisp) {___jdce_logger("/js/libs/lavaca.js", 51);
     ...
     * @return {Lavaca.events.EventDispatcher}  This event dispatcher (for chaining)
     */
    trigger: function(type, params) {___jdce_logger("/js/libs/lavaca.js", 52);
     ...
     * @return {Object}  The event object
     */
    createEvent: function(type, params) {___jdce_logger("/js/libs/lavaca.js", 53);
...
define('lavaca/env/ChildBrowser',['require','lavaca/env/Device','lavaca/events/EventDispatcher','lavaca/util/Promise'],function(require) {___jdce_logger("/js/libs/lavaca.js", 54);
  ...
  var ChildBrowser = EventDispatcher.extend({
     ...
     * @return {Lavaca.util.Promise}  A promise
     */
    showWebPage: function(loc) {___jdce_logger("/js/libs/lavaca.js", 55);
      if (Device.isCordova()) {
        return Device
          .exec('ChildBrowser', 'showWebPage', [loc])
          .error(function() {___jdce_logger("/js/libs/lavaca.js", 56);
     ...
     * @return {Lavaca.util.Promise}  A promise
     */
    close: function() {___jdce_logger("/js/libs/lavaca.js", 57);
...
define('lavaca/env/Detection',['require','$'],function(require) {___jdce_logger("/js/libs/lavaca.js", 58);
  var $ = require('$');
  var Detection = {};
  ...
  Detection.android23AndBelow = (function() {___jdce_logger("/js/libs/lavaca.js", 59);
  ...
  Detection.iOS4AndBelow = (function() {___jdce_logger("/js/libs/lavaca.js", 60);
  ...
  Detection.addCustomDetection = function(condition, feature, selector) {___jdce_logger("/js/libs/lavaca.js", 61);
    var el;
...
define('lavaca/env/Device',['require','$','cordova','lavaca/util/Promise'],function(require) {___jdce_logger("/js/libs/lavaca.js", 62);
   ...
   * @return {Boolean}  True if app is being run through Cordova
   */
  Device.isCordova = function() {___jdce_logger("/js/libs/lavaca.js", 63);
    return !!Cordova;
  };
  /**
   * Registers a plugin to be initialized when the device is ready
   ...
   * @param {Function} TPlugin  The plugin to register. The plugin should be a constructor function
   */
  Device.register = function(name, TPlugin) {___jdce_logger("/js/libs/lavaca.js", 64);
    function install() {___jdce_logger("/js/libs/lavaca.js", 65);
      if (!window.plugins) {
        window.plugins = {};
      }
      window.plugins[name] = new TPlugin();
   ...
   * @return {Lavaca.util.Promise}  A promise
   */
  Device.exec = function(className, methodName, args) {___jdce_logger("/js/libs/lavaca.js", 66);
    var promise = new Promise(window);
    if (Cordova) {
      Cordova.exec(promise.resolver(), promise.rejector(), className, methodName, args);
    } else {
   ...
   * @param {Function} callback  The handler to execute when the device is ready
   */
  Device.init = function(callback) {___jdce_logger("/js/libs/lavaca.js", 67);
    if (!Cordova) {
      $(document).ready(callback);
    }
    else if (document.addEventListener) {
  ...
  $(document).ready(function() {___jdce_logger("/js/libs/lavaca.js", 68);
    var i = -1,
        installPlugin;
    while (!!(installPlugin = _onInit[++i])) {
      installPlugin();
...
define('lavaca/events/EventDispatcher',['require','lavaca/util/Disposable','mout/object/deepMixIn'],function(require) {___jdce_logger("/js/libs/lavaca.js", 69);
  ...
  var EventDispatcher = Disposable.extend({
     ...
     * @return {Lavaca.events.EventDispatcher}  This event dispatcher (for chaining)
     */
    on: function(type, callback, thisp) {___jdce_logger("/js/libs/lavaca.js", 70);
      var calls = this.callbacks || (this.callbacks = {}),
          list = calls[type] || (calls[type] = []);
      list[list.length] = {fn: callback, thisp: thisp};
      return this;
     ...
     * @return {Lavaca.events.EventDispatcher}  This event dispatcher (for chaining)
     */
    off: function(type, callback, thisp) {___jdce_logger("/js/libs/lavaca.js", 71);
      var calls = this.callbacks,
          list,
          handler,
          i = -1,
     ...
     * @return {Lavaca.events.EventDispatcher}  This event dispatcher (for chaining)
     */
    trigger: function(type, params) {___jdce_logger("/js/libs/lavaca.js", 72);
      if (!this.suppressEvents && this.callbacks) {
        var list = this.callbacks[type],
            event = this.createEvent(type, params),
            i = -1,
     ...
     * @return {Object}  The event object
     */
    createEvent: function(type, params) {___jdce_logger("/js/libs/lavaca.js", 73);
      return deepMixIn({}, params || {}, {
        type: type,
        target: params && params.target ? params.target : this,
        currentTarget: this
...
define('lavaca/fx/Transform',['require','$'],function(require) {___jdce_logger("/js/libs/lavaca.js", 74);
  ...
  (function() {___jdce_logger("/js/libs/lavaca.js", 75);
  ...
  function _isUndefined(value) {___jdce_logger("/js/libs/lavaca.js", 76);
    return value === UNDEFINED;
  }

  function _toOriginUnit(v) {___jdce_logger("/js/libs/lavaca.js", 77);
    return typeof v === 'number' ? v * 100 + '%' : v;
  }

  function _scrubRotateValue(v) {___jdce_logger("/js/libs/lavaca.js", 78);
    return typeof v === 'number' ? v + 'deg' : v;
  }

  function _scrubTranslateValue(v) {___jdce_logger("/js/libs/lavaca.js", 79);
    return typeof v === 'number' ? v + 'px' : v;
  }

  function _scrubScaleValue(v) {___jdce_logger("/js/libs/lavaca.js", 80);
    return typeof v === 'number' ? v + ',' + v : v;
  }

  function _scrubTransformValue(prop, value) {___jdce_logger("/js/libs/lavaca.js", 81);
   ...
   */
  Transform.isSupported = function() {___jdce_logger("/js/libs/lavaca.js", 82);
    return !!_prop;
  };
   ...
   */
  Transform.is3dSupported = function() {___jdce_logger("/js/libs/lavaca.js", 83);
    return _3d;
  };
   ...
   */
  Transform.toCSS = function(opts) {___jdce_logger("/js/libs/lavaca.js", 84);
    var css = [],
        prop;
   ...
   */
  Transform.cssProperty = function() {___jdce_logger("/js/libs/lavaca.js", 85);
    return _cssProp;
  };
   ...
   * @return {jQuery}  The jQuery object, for chaining
   */
  $.fn.transform = function(value, origin) {___jdce_logger("/js/libs/lavaca.js", 86);
    if (Transform.isSupported()) {
      ...
      this.each(function() {___jdce_logger("/js/libs/lavaca.js", 87);
...
define('lavaca/fx/Animation',['require','$','./Transform'],function(require) {___jdce_logger("/js/libs/lavaca.js", 88);
  ...
  (function() {___jdce_logger("/js/libs/lavaca.js", 89);
    var style = document.createElement('div').style,
        s,
        opts;
    for (s in _props) {
   ...
   */
  Animation.isSupported = function() {___jdce_logger("/js/libs/lavaca.js", 90);
    return !!_prop;
  };
   ...
   */
  Animation.keyframesToCSS = function(name, keyframes) {___jdce_logger("/js/libs/lavaca.js", 91);
   ...
   * @return {String}  The name fo the animation
   */
  Animation.generateKeyframes = function(name, keyframes) {___jdce_logger("/js/libs/lavaca.js", 92);
   ...
   * @return {String}  The name of the CSS property
   */
  Animation.cssProperty = function() {___jdce_logger("/js/libs/lavaca.js", 93);
    return _cssProp;
  };
  ...
  */
   ...
   * @return {jQuery}  The jQuery object, for chaining
   */
  $.fn.keyframe = function(name, duration, easing, delay, iterations, direction, callback) {___jdce_logger("/js/libs/lavaca.js", 94);
   ...
   * @return {jQuery}  This jQuery object, for chaining
   */
  $.fn.animationEnd = function(delegate, callback) {___jdce_logger("/js/libs/lavaca.js", 95);
    if (_event) {
   ...
   * @return {jQuery}  This jQuery object, for chaining
   */
  $.fn.nextAnimationEnd = function(delegate, callback) {___jdce_logger("/js/libs/lavaca.js", 96);
    if (_event) {
...
define('lavaca/fx/Transition',['require','$'],function(require) {___jdce_logger("/js/libs/lavaca.js", 97);
  ...
  (function() {___jdce_logger("/js/libs/lavaca.js", 98);
    var style = document.createElement('div').style,
        s;
    for (s in _props) {
      if (s in style) {
   ...
   */
  Transition.isSupported = function() {___jdce_logger("/js/libs/lavaca.js", 99);
    return !!_prop;
  };
 ...
 /**
   ...
   * @return {String}  The generated CSS string
   */
  Transition.toCSS = function(props, duration, easing) {___jdce_logger("/js/libs/lavaca.js", 100);
    easing = easing || 'linear';
    var css = [],
   ...
   * @return {String}  The name of the CSS property
   */
  Transition.cssProperty = function() {___jdce_logger("/js/libs/lavaca.js", 101);
    return _cssProp;
  };
...
/**
   ...
   * @return {jQuery}  The jQuery object, for chaining
   */
  $.fn.transition = function(props, duration, easing, callback) {___jdce_logger("/js/libs/lavaca.js", 102);
    ...
    if (Transition.isSupported()) {
      ...
      this.each(function() {___jdce_logger("/js/libs/lavaca.js", 103);
   ...
   * @return {jQuery}  The jQuery object, for chaining
   */
  $.fn.transitionEnd = function(delegate, callback) {___jdce_logger("/js/libs/lavaca.js", 104);
    if (_event) {
      return this.on(_event, delegate, callback);
    } else {
      return this;
   ...
   * @return {jQuery}  The jQuery object, for chaining
   */
  $.fn.nextTransitionEnd = function(delegate, callback) {___jdce_logger("/js/libs/lavaca.js", 105);
    if (_event) {
      return this.one(_event, delegate, callback);
    } else {
      return this;
...
define('lavaca/util/uuid',[],function() {___jdce_logger("/js/libs/lavaca.js", 106);
   ...
   */
  var uuid = function(namespace) {___jdce_logger("/js/libs/lavaca.js", 107);
...
define('lavaca/net/History',['require','lavaca/events/EventDispatcher','lavaca/util/uuid'],function(require) {___jdce_logger("/js/libs/lavaca.js", 108);
  ...
  function _insertState(hist, position, id, state, title, url) {___jdce_logger("/js/libs/lavaca.js", 109);
   ...
   * @constructor
   */
  var History = EventDispatcher.extend(function() {___jdce_logger("/js/libs/lavaca.js", 110);
    ...
    if (_standardsMode) {
       ...
       */
       var self = this;
      this.onPopState = function(e) {___jdce_logger("/js/libs/lavaca.js", 111);
        if (e.state) {
          _pushCount--;
      ...
      this.onPopState = function() {___jdce_logger("/js/libs/lavaca.js", 112);
     ...
     */
    current: function() {___jdce_logger("/js/libs/lavaca.js", 113);
     ...
     */
    hasHistory: function() {___jdce_logger("/js/libs/lavaca.js", 114);
      return _pushCount > 0;
    },
    /**
     ...
     */
    push: function(state, title, url) {___jdce_logger("/js/libs/lavaca.js", 115);
      _pushCount++;
      if (_hasPushed) {
     ...
     * @param {String} url  The URL of the page state
     */
    replace: function(state, title, url) {___jdce_logger("/js/libs/lavaca.js", 116);
      _hasPushed = true;
      document.title = title;
      if (_standardsMode) {
     ...
     * @method dispose
     */
    dispose: function() {___jdce_logger("/js/libs/lavaca.js", 117);
      if (this.onPopState) {
        if (_standardsMode) {
   ...
   * @return {Lavaca.mvc.History}  The history instance
   */
  History.init = function(useHash) {___jdce_logger("/js/libs/lavaca.js", 118);
    if (!_hist) {
      if (useHash) {
   ...
   * @param {String} url  The URL of the page state
   */
  History.push = function() {___jdce_logger("/js/libs/lavaca.js", 119);
   ...
   * @param {String} url  The URL of the page state
   */
  History.replace = function() {___jdce_logger("/js/libs/lavaca.js", 120);
   ...
   * @static
   */
  History.back = function() {___jdce_logger("/js/libs/lavaca.js", 121);
    history.back();
  };
  /**
   ...
   * @static
   */
  History.forward = function() {___jdce_logger("/js/libs/lavaca.js", 122);
    history.forward();
  };
  /**
   * Unbind the history object and ready it for garbage collection
   ...
   * @static
   */
  History.dispose = function() {___jdce_logger("/js/libs/lavaca.js", 123);
    if (_hist) {
      _hist.dispose();
      _hist = null;
    }
   ...
   */
  History.on = function() {___jdce_logger("/js/libs/lavaca.js", 124);
   ...
   * @return {Lavaca.mvc.History}  The history object (for chaining)
   */
  History.off = function() {___jdce_logger("/js/libs/lavaca.js", 125);
   ...
   * @static
   */
  History.overrideStandardsMode = function() {___jdce_logger("/js/libs/lavaca.js", 126);
...
define('lavaca/util/delay',[],function() {___jdce_logger("/js/libs/lavaca.js", 127);
  /**
   ...
   * @return {Number}  The timeout ID
   */
  var delay = function(callback, thisp, ms) {___jdce_logger("/js/libs/lavaca.js", 128);
    return setTimeout(function() {___jdce_logger("/js/libs/lavaca.js", 129);
      callback.call(thisp);
    }, ms || 0);
  };
...
define('mout/lang/kindOf',[],function () {___jdce_logger("/js/libs/lavaca.js", 130);
     ...
     */
    function kindOf(val) {___jdce_logger("/js/libs/lavaca.js", 131);
        if (val === null) {
            return 'Null';
        } else if (val === UNDEF) {
            return 'Undefined';
...
define('mout/object/mixIn',['./forOwn'], function(forOwn){___jdce_logger("/js/libs/lavaca.js", 132);
    ...
    */
    function mixIn(target, objects){___jdce_logger("/js/libs/lavaca.js", 133);
        var i = 0,
            n = arguments.length,
            obj;
        while(++i < n){
    ...
    function copyProp(val, key){___jdce_logger("/js/libs/lavaca.js", 134);
        this[key] = val;
    }
...
define('mout/lang/clone',['./kindOf', './isPlainObject', '../object/mixIn'], function (kindOf, isPlainObject, mixIn) {___jdce_logger("/js/libs/lavaca.js", 135);

    /**
     * Clone native types.
     */
    function clone(val){___jdce_logger("/js/libs/lavaca.js", 136);
        switch (kindOf(val)) {
            case 'Object':
    ...
    function cloneObject(source) {___jdce_logger("/js/libs/lavaca.js", 137);
    ...
    function cloneRegExp(r) {___jdce_logger("/js/libs/lavaca.js", 138);
        var flags = '';
        flags += r.multiline ? 'm' : '';
        flags += r.global ? 'g' : '';
    ...
    function cloneDate(date) {___jdce_logger("/js/libs/lavaca.js", 139);
        return new Date(+date);
    }

    function cloneArray(arr) {___jdce_logger("/js/libs/lavaca.js", 140);
        return arr.slice();
    }
...
define('mout/lang/deepClone',['./clone', '../object/forOwn', './kindOf', './isPlainObject'], function (clone, forOwn, kindOf, isPlainObject) {___jdce_logger("/js/libs/lavaca.js", 141);

    /**
     * Recursively clone native types.
     */
    function deepClone(val, instanceClone) {___jdce_logger("/js/libs/lavaca.js", 142);
        switch ( kindOf(val) ) {
            case 'Object':
    ...
    function cloneObject(source, instanceClone) {___jdce_logger("/js/libs/lavaca.js", 143);
        if (isPlainObject(source)) {
            var out = {};
            forOwn(source, function(val, key) {___jdce_logger("/js/libs/lavaca.js", 144);
    ...
    function cloneArray(arr, instanceClone) {___jdce_logger("/js/libs/lavaca.js", 145);
        var out = [],
            i = -1,
            n = arr.length,
            val;
...
define('mout/lang/isKind',['./kindOf'], function (kindOf) {___jdce_logger("/js/libs/lavaca.js", 146);
    /**
     * Check if value is from a specific "kind".
     */
    function isKind(val, kind){___jdce_logger("/js/libs/lavaca.js", 147);
        return kindOf(val) === kind;
    }
    return isKind;
});

define('mout/lang/isObject',['./isKind'], function (isKind) {___jdce_logger("/js/libs/lavaca.js", 148);
    /**
     */
    function isObject(val) {___jdce_logger("/js/libs/lavaca.js", 149);
        return isKind(val, 'Object');
    }
    return isObject;
});

define('mout/object/merge',['./hasOwn', '../lang/deepClone', '../lang/isObject'], function (hasOwn, deepClone, isObject) {___jdce_logger("/js/libs/lavaca.js", 150);

    /**
     * Deep merge objects.
     */
    function merge() {___jdce_logger("/js/libs/lavaca.js", 151);
        var i = 1,
            key, val, obj, target;
...
define('lavaca/mvc/Route',['require','lavaca/util/Disposable','lavaca/util/delay','mout/lang/deepClone','mout/object/merge'],function(require) {___jdce_logger("/js/libs/lavaca.js", 152);
  ...
  function _multivariablePattern() {___jdce_logger("/js/libs/lavaca.js", 153);
    return new RegExp('\\{\\*(.*?)\\}', 'g');
  }

  function _variablePattern() {___jdce_logger("/js/libs/lavaca.js", 154);
    return new RegExp('\\{([^\\/]*?)\\}', 'g');
  }

  function _variableCharacters() {___jdce_logger("/js/libs/lavaca.js", 155);
    return new RegExp('[\\{\\}\\*]', 'g');
  }

  function _datePattern() {___jdce_logger("/js/libs/lavaca.js", 156);
    return new RegExp('^\\d{4}-[0-1]\\d-[0-3]\\d$', 'g');
  }

  function _patternToRegExp(pattern) {___jdce_logger("/js/libs/lavaca.js", 157);
    if (pattern === '/') {
      return new RegExp('^\\/(\\?.*)?(#.*)?$', 'g');
    }
    if (pattern.charAt(0) === '/') {
  ...
  function _scrubURLValue(value) {___jdce_logger("/js/libs/lavaca.js", 158);
   ...
   */
  var Route = Disposable.extend(function(pattern, TController, action, params) {___jdce_logger("/js/libs/lavaca.js", 159);
     ...
     */
    matches: function(url) {___jdce_logger("/js/libs/lavaca.js", 160);
     ...
     */
    parse: function(url) {___jdce_logger("/js/libs/lavaca.js", 161);
     ...
     * @return {Lavaca.util.Promise}  A promise
     */
    exec: function(url, router, viewManager, state, params) {___jdce_logger("/js/libs/lavaca.js", 162);
      ...
      function dispose() {___jdce_logger("/js/libs/lavaca.js", 163);
...
define('lavaca/mvc/Router',['require','./Route','lavaca/net/History','lavaca/util/Disposable','lavaca/util/Promise'],function(require) {___jdce_logger("/js/libs/lavaca.js", 164);
   ...
   */
  var Router = Disposable.extend(function(viewManager) {___jdce_logger("/js/libs/lavaca.js", 165);
    Disposable.call(this);
    /**
     * @field {Array} routes
     * @default []
    ...
    startHistory: function() {___jdce_logger("/js/libs/lavaca.js", 166);
      this.onpopstate = function(e) {___jdce_logger("/js/libs/lavaca.js", 167);
        if (this.hasNavigated) {
          History.isRoutingBack = e.direction === 'back';
          this.exec(e.url, e).always(function() {___jdce_logger("/js/libs/lavaca.js", 168);
            History.isRoutingBack = false;
          });
        }
      };
     ...
     */
    setViewManager: function(viewManager) {___jdce_logger("/js/libs/lavaca.js", 169);
      this.viewManager = viewManager;
      return this;
    },
    /**
     ...
     * @return {Lavaca.mvc.Router}  The router (for chaining)
     */
    add: function(pattern, TController, action, params) {___jdce_logger("/js/libs/lavaca.js", 170);
     ...
     * @return {Lavaca.util.Promise}  A promise
     */
    exec: function(url, state, params) {___jdce_logger("/js/libs/lavaca.js", 171);
      if (this.locked) {
      ...
      promise.always(function() {___jdce_logger("/js/libs/lavaca.js", 172);
        this.unlock();
      });
      if (!this.hasNavigated) {
        promise.success(function() {___jdce_logger("/js/libs/lavaca.js", 173);
     ...
     */
    unlock: function() {___jdce_logger("/js/libs/lavaca.js", 174);
      this.locked = false;
      return this;
    },
    /**
     ...
     * @method dispose
     */
    dispose: function() {___jdce_logger("/js/libs/lavaca.js", 175);
      if (this.onpopstate) {
...
define('lavaca/util/resolve',[],function() {___jdce_logger("/js/libs/lavaca.js", 176);
  /**
   ...
   * @return {Object}  The resolved object
   */
  var resolve = function(name, createIfNotExists, root) {___jdce_logger("/js/libs/lavaca.js", 177);
    if (!name) {
      return null;
    }
    name = name.split('.');
...
define('lavaca/net/Connectivity',['require','$','lavaca/util/Promise','lavaca/util/resolve'],function(require) {___jdce_logger("/js/libs/lavaca.js", 178);
  ...
  function _onAjaxError(arg) {___jdce_logger("/js/libs/lavaca.js", 179);
   ...
   */
  Connectivity.isOffline = function() {___jdce_logger("/js/libs/lavaca.js", 180);
   ...
   * @return {Lavaca.util.Promise}  A promise
   */
  Connectivity.ajax = function(opts) {___jdce_logger("/js/libs/lavaca.js", 181);
    var promise = new Promise(),
        origSuccess = opts.success,
        origError = opts.error;
    opts.success = function() {___jdce_logger("/js/libs/lavaca.js", 182);
      if (origSuccess) {
        origSuccess.apply(this, arguments);
      }
      promise.resolve.apply(promise, arguments);
    };
    opts.error = function() {___jdce_logger("/js/libs/lavaca.js", 183);
      if (origError) {
   ...
   * @param {Function} callback  The callback to execute
   */
  Connectivity.registerOfflineAjaxHandler = function(callback) {___jdce_logger("/js/libs/lavaca.js", 184);
...
define('lavaca/util/ArrayUtils',[],function() {___jdce_logger("/js/libs/lavaca.js", 185);
   ...
   */
  ArrayUtils.indexOf = function(a, o) {___jdce_logger("/js/libs/lavaca.js", 186);
    if (!a) {
      return -1;
    } else if (a.indexOf) {
      return a.indexOf(o);
   ...
   */
  ArrayUtils.contains = function(a, o) {___jdce_logger("/js/libs/lavaca.js", 187);
   ...
   *   in the array)
   */
  ArrayUtils.remove = function(a, o) {___jdce_logger("/js/libs/lavaca.js", 188);
   ...
   */
  ArrayUtils.pushIfNotExists = function(a, o) {___jdce_logger("/js/libs/lavaca.js", 189);
    var index = ArrayUtils.indexOf(a, o);
    if (index === -1) {
      a[index = a.length] = o;
    }
   ...
   */
  ArrayUtils.isArray = function(a) {___jdce_logger("/js/libs/lavaca.js", 190);
...
define('lavaca/util/Cache',['require','lavaca/util/Disposable','lavaca/util/uuid'],function(require) {___jdce_logger("/js/libs/lavaca.js", 191);
  ...
  var Cache = Disposable.extend({
     ...
     */
    get: function(id, def) {___jdce_logger("/js/libs/lavaca.js", 192);
      var result = this['@' + id];
     ...
     */
    set: function(id, value) {___jdce_logger("/js/libs/lavaca.js", 193);
      this['@' + id] = value;
    },
    /**
     ...
     */
    add: function(value) {___jdce_logger("/js/libs/lavaca.js", 194);
      var id = uuid();
      this.set(id, value);
      return id;
    },
     ...
     * @param {String} id  The key under which the item is stored
     */
    remove: function(id) {___jdce_logger("/js/libs/lavaca.js", 195);
      delete this['@' + id];
    },
    /**
     ...
     */
    each: function(cb, thisp) {___jdce_logger("/js/libs/lavaca.js", 196);
      var prop, returned;
      for (prop in this) {
     ...
     */
    toObject: function() {___jdce_logger("/js/libs/lavaca.js", 197);
      var result = {};
      this.each(function(prop, value) {___jdce_logger("/js/libs/lavaca.js", 198);
     ...
     */
    toJSON: function() {___jdce_logger("/js/libs/lavaca.js", 199);
     ...
     */
    toArray: function() {___jdce_logger("/js/libs/lavaca.js", 200);
      var results = [];
      results['ids'] = [];
      this.each(function(prop, value) {___jdce_logger("/js/libs/lavaca.js", 201);
     ...
     * @method clear
     */
    clear: function() {___jdce_logger("/js/libs/lavaca.js", 202);
       this.each(function(key, item) {___jdce_logger("/js/libs/lavaca.js", 203);
         this.remove(key);
       }, this);
    },
     ...
     * @method count
     */
    count: function() {___jdce_logger("/js/libs/lavaca.js", 204);
      var count = 0;
      this.each(function(key, item) {___jdce_logger("/js/libs/lavaca.js", 205);
        count++;
      }, this);
      return count;
    },
     ...
     * @method dispose
     */
    dispose: function() {___jdce_logger("/js/libs/lavaca.js", 206);
      this.clear();
      Disposable.prototype.dispose.apply(this, arguments);
    }
  });
...
define('lavaca/util/Map',['require','$','./Cache','./Disposable','lavaca/net/Connectivity'],function(require) {___jdce_logger("/js/libs/lavaca.js", 207);
  ...
  function _absolute(url) {___jdce_logger("/js/libs/lavaca.js", 208);
   ...
   */
  var Map = Disposable.extend(function(name, src, code) {___jdce_logger("/js/libs/lavaca.js", 209);
    Disposable.call(this);
    /**
     ...
     */
    is: function(name) {___jdce_logger("/js/libs/lavaca.js", 210);
     ...
     */
    get: function(code) {___jdce_logger("/js/libs/lavaca.js", 211);
      if (!this.hasLoaded) {
        if (this.code) {
          this.add(this.code);
        } else if (this.src) {
     ...
     */
    add: function(data) {___jdce_logger("/js/libs/lavaca.js", 212);
      for (var n in data) {
     ...
     */
    process: function(text) {___jdce_logger("/js/libs/lavaca.js", 213);
     ...
     */
    load: function(url) {___jdce_logger("/js/libs/lavaca.js", 214);
      var self = this;
      Connectivity.ajax({
        async: false,
        url: url,
        success: function(resp) {___jdce_logger("/js/libs/lavaca.js", 215);
          self.process(resp);
        }
      });
    }
   ...
   */
  Map.setDefault = function(cache, name) {___jdce_logger("/js/libs/lavaca.js", 216);
    var map = name;
   ...
   */
  Map.get = function(cache, name, code, defaultName) {___jdce_logger("/js/libs/lavaca.js", 217);
    if (!code) {
      code = name;
      name = defaultName;
    }
   ...
   */
  Map.init = function(cache, mimeType, construct, scope) {___jdce_logger("/js/libs/lavaca.js", 218);
    $(scope || document.documentElement)
      .find('script[type="' + mimeType + '"]')
      .each(function() {___jdce_logger("/js/libs/lavaca.js", 219);
        var item = $(this),
   ...
   * @param {Lavaca.util.Cache} cache  The map cache
   */
  Map.dispose = function(cache) {___jdce_logger("/js/libs/lavaca.js", 220);
    cache.dispose();
  };
...
define('lavaca/util/Config',['require','./Cache','./Map'],function(require) {___jdce_logger("/js/libs/lavaca.js", 221);
  ...
  function _construct(name, src, code) {___jdce_logger("/js/libs/lavaca.js", 222);
    if (code) {
   ...
   */
  Config.setDefault = function(name) {___jdce_logger("/js/libs/lavaca.js", 223);
   ...
   */
  Config.currentEnvironment = function() {___jdce_logger("/js/libs/lavaca.js", 224);
   ...
   * @return {Object}  The value of the parameter
   */
  Config.get = function(name, code) {___jdce_logger("/js/libs/lavaca.js", 225);
   ...
   * @param {jQuery} scope  The element to which to limit the scan
   */
  Config.init = function(scope) {___jdce_logger("/js/libs/lavaca.js", 226);
   ...
   * @static
   */
  Config.dispose = function() {___jdce_logger("/js/libs/lavaca.js", 227);
    Map.dispose(_cache);
  };
...
define('lavaca/mvc/Model',['require','lavaca/events/EventDispatcher','lavaca/net/Connectivity','lavaca/util/ArrayUtils','lavaca/util/Cache','lavaca/util/Promise','mout/lang/deepClone','mout/object/merge','lavaca/util/Config'],function(require) {___jdce_logger("/js/libs/lavaca.js", 228);
  ...
  function _triggerAttributeEvent(model, event, attribute, previous, value, messages) {___jdce_logger("/js/libs/lavaca.js", 229);
    model.trigger(event, {
      attribute: attribute,
  ...
  function _setFlagOn(model, name, flag) {___jdce_logger("/js/libs/lavaca.js", 230);
  ...
  function _suppressChecked(model, suppress, callback) {___jdce_logger("/js/libs/lavaca.js", 231);
    suppress = !!suppress;
  ...
  function _isValid(messages){___jdce_logger("/js/libs/lavaca.js", 232);
    var isValid = true;
   ...
   */
  var Model = EventDispatcher.extend(function(map) {___jdce_logger("/js/libs/lavaca.js", 233);
    EventDispatcher.call(this);
     ...
     */
    get: function(attribute) {___jdce_logger("/js/libs/lavaca.js", 234);
     ...
     */
    canSet: function() {___jdce_logger("/js/libs/lavaca.js", 235);
      return true;
    },
    /**
...
//* @event change
    ...
    set: function(attribute, value, flag, suppress) {___jdce_logger("/js/libs/lavaca.js", 236);
      return _suppressChecked(this, suppress, function() {___jdce_logger("/js/libs/lavaca.js", 237);
     ...
     */
    has: function(attribute) {___jdce_logger("/js/libs/lavaca.js", 238);
     ...
     */
    id: function() {___jdce_logger("/js/libs/lavaca.js", 239);
     ...
     */
    isNew: function() {___jdce_logger("/js/libs/lavaca.js", 240);
      return null === this.id();
    },
    /**
     ...
     */
    parse: function(map) {___jdce_logger("/js/libs/lavaca.js", 241);
      if (typeof map === 'string') {
        map = JSON.parse(map);
      }
      return map;
     ...
     * @param {Boolean} suppress  When true, validation, events and tracking are suppressed
     */
    apply: function(map, suppress) {___jdce_logger("/js/libs/lavaca.js", 242);
      _suppressChecked(this, suppress, function() {___jdce_logger("/js/libs/lavaca.js", 243);
        map = this.parse(map);
        for (var n in map) {
          this.set(n, map[n]);
        }
     ...
     */
    clear: function(flag) {___jdce_logger("/js/libs/lavaca.js", 244);
      if (flag) {
     ...
     */
    clone: function() {___jdce_logger("/js/libs/lavaca.js", 245);
     ...
     */
    addRule: function(attribute, callback, message) {___jdce_logger("/js/libs/lavaca.js", 246);
     ...
     * @return {Array}  A list of validation error messages
     */
    validate: function(attribute, value) {___jdce_logger("/js/libs/lavaca.js", 247);
      var messages,
          rules,
          i = -1,
          rule;
      if (attribute) {
        ...
        messages = {};
        this.rules.each(function(attributeName) {___jdce_logger("/js/libs/lavaca.js", 248);
     ...
     */
    onFetchSuccess: function(response) {___jdce_logger("/js/libs/lavaca.js", 249);
     ...
     */
    onFetchError: function(response) {___jdce_logger("/js/libs/lavaca.js", 250);
     ...
     * @return {Lavaca.util.Promise}  A promise
     */
    fetch: function(url, options) {___jdce_logger("/js/libs/lavaca.js", 251);
     ...
     */
    getApiURL: function(relPath) {___jdce_logger("/js/libs/lavaca.js", 252);
...
//* @event saveError
    ...
    save: function(callback, thisp) {___jdce_logger("/js/libs/lavaca.js", 253);
      ...
      promise
        .success(function(value) {___jdce_logger("/js/libs/lavaca.js", 254);
        ...
        .error(function(value) {___jdce_logger("/js/libs/lavaca.js", 255);
     ...
     * @return {Lavaca.util.Promise}  A promise
     */
    saveToServer: function(url) {___jdce_logger("/js/libs/lavaca.js", 256);
      return this.save(function(model, changedAttributes, attributes) {___jdce_logger("/js/libs/lavaca.js", 257);
        var id = this.id(),
            data;
        if (this.isNew()) {
          data = attributes;
     ...
     */
    toObject: function() {___jdce_logger("/js/libs/lavaca.js", 258);
     ...
     */
    toJSON: function() {___jdce_logger("/js/libs/lavaca.js", 259);
      return JSON.stringify(this.toObject());
    },
    /**
     * Bind an event handler to this object
     ...
     * @return {Lavaca.events.EventDispatcher}  This event dispatcher (for chaining)
     */
    on: function(type, attr, callback, thisp) {___jdce_logger("/js/libs/lavaca.js", 260);
      if (typeof attr === 'function') {
        thisp = callback;
        callback = attr;
        attr = null;
      }
      function handler(e) {___jdce_logger("/js/libs/lavaca.js", 261);
    ...
    */
    responseFilter: function(response) {___jdce_logger("/js/libs/lavaca.js", 262);
      return response;
    }
  });
  /**
...
define('lavaca/ui/Template',['require','lavaca/util/Cache','lavaca/util/Map'],function(require) {___jdce_logger("/js/libs/lavaca.js", 263);
  ...
  var Template = Map.extend({
     ...
     * @method compile
     */
    compile: function() {___jdce_logger("/js/libs/lavaca.js", 264);
      // Do nothing
    },
    /**
     ...
     * @return {Lavaca.util.Promise}  A promise
     */
    render: function() {___jdce_logger("/js/libs/lavaca.js", 265);
      throw 'Abstract';
    },
    /**
     ...
     * @param {String} text  The server data string
     */
    process: function(text) {___jdce_logger("/js/libs/lavaca.js", 266);
      this.code = text;
    }
  });
  /**
   ...
   */
  Template.get = function(name) {___jdce_logger("/js/libs/lavaca.js", 267);
   ...
   * @param {jQuery} scope  The element to which to limit the scan
   */
  Template.init = function(scope) {___jdce_logger("/js/libs/lavaca.js", 268);
    var i = -1,
        type, templates, templateName, template;

    while (!!(type = _types[++i])) {
      var construct = function(name, src, code) {___jdce_logger("/js/libs/lavaca.js", 269);
   ...
   * @static
   */
  Template.dispose = function() {___jdce_logger("/js/libs/lavaca.js", 270);
    Map.dispose(_cache);
  };
  /**
   ...
   * @return {Lavaca.util.Promise}  A promise
   */
  Template.render = function(name, model) {___jdce_logger("/js/libs/lavaca.js", 271);
   ...
   * @param {Function} TTemplate  The JavaScript type used for the template (should derive from [[Lavaca.ui.Template]])
   */
  Template.register = function(mimeType, TTemplate) {___jdce_logger("/js/libs/lavaca.js", 272);
...
define('lavaca/util/log',[],function() {___jdce_logger("/js/libs/lavaca.js", 273);
  /**
   ...
   */
  var log = function() {___jdce_logger("/js/libs/lavaca.js", 274);
    if (window.console) {
...
define('lavaca/mvc/View',['require','$','lavaca/events/EventDispatcher','lavaca/mvc/Model','lavaca/ui/Template','lavaca/util/Cache','lavaca/util/Promise','lavaca/util/log','lavaca/util/uuid'],function(require) {___jdce_logger("/js/libs/lavaca.js", 275);
   ...
   *
   */
  var View = EventDispatcher.extend(function(el, model, parentView) {___jdce_logger("/js/libs/lavaca.js", 276);
    EventDispatcher.call(this);
     ...
     * @return {lavaca.util.Promise} A promise
     */
    render: function() {___jdce_logger("/js/libs/lavaca.js", 277);
      var self = this,
        promise = new Promise(this),
       ...
       */
      promise
        .success(function(html) {___jdce_logger("/js/libs/lavaca.js", 278);
       ...
       * @event rendererror
       */
        .error(function(err) {___jdce_logger("/js/libs/lavaca.js", 279);
      ...
      template
        ...
        .then(function() {___jdce_logger("/js/libs/lavaca.js", 280);
          if (self.className){
     ...
     * @return {lavaca.util.Promise}  A promise
     */
    redraw: function(selector, model) {___jdce_logger("/js/libs/lavaca.js", 281);
      var self = this,
      ...
      function processMaps() {___jdce_logger("/js/libs/lavaca.js", 282);
        self.createWidgets();
        self.createChildViews();
        self.applyChildViewEvents();
      }
      templateRenderPromise
        .success(function(html) {___jdce_logger("/js/libs/lavaca.js", 283);
          if (replaceAll) {
          ...
          if(selector) {
            ...
            if($newEl.length === $oldEl.length) {
              $oldEl.each(function(index) {___jdce_logger("/js/libs/lavaca.js", 284);
                var $el = $(this);
     ...
     */
    disposeChildViews: function ($el) {___jdce_logger("/js/libs/lavaca.js", 285);
      var childViewSearch,
        self = this;
      ...
      childViewSearch.each(function(index, item) {___jdce_logger("/js/libs/lavaca.js", 286);
        var $item = $(item),
     ...
     * @param  {Object} $el the $el to search for child views and widgets in
     */
    disposeWidgets: function ($el) {___jdce_logger("/js/libs/lavaca.js", 287);
      var self = this;

      // Remove widgets
      $el.add($el.find('[data-has-widgets]')).each(function(index, item) {___jdce_logger("/js/libs/lavaca.js", 288);
        var $item = $(item),
     ...
     *
     */
    clearModelEvents: function() {___jdce_logger("/js/libs/lavaca.js", 289);
      var type,
        callback,
        dotIndex;
      if (this.eventMap
     ...
     */
    bindMappedEvents: function() {___jdce_logger("/js/libs/lavaca.js", 290);
      var callbacks,
        delegate,
        type;
     ...
     *
     */
    applyEvents: function() {___jdce_logger("/js/libs/lavaca.js", 291);
      var el = this.el,
        callbacks,
        callback,
        property,
     ...
     * @return {lavaca.mvc.View}  This view (for chaining)
     */
    mapEvent: function(delegate, type, callback) {___jdce_logger("/js/libs/lavaca.js", 292);
      var o;
     ...
     *
     */
    createWidgets: function() {___jdce_logger("/js/libs/lavaca.js", 293);
      ...
      for (n in this.widgetMap) {
        ...
        (n === 'self' ? this.el : this.el.find(n))
          .each(function(index, item) {___jdce_logger("/js/libs/lavaca.js", 294);
            var $el = $(item),
     ...
     * @return {Lavaca.mvc.View}  This view (for chaining)
     */
    mapWidget: function(selector, TWidget) {___jdce_logger("/js/libs/lavaca.js", 295);
     ...
     *
     */
    createChildViews: function() {___jdce_logger("/js/libs/lavaca.js", 296);
      ...
      for (n in this.childViewMap) {
        ...
        this.el.find(n)
          .each(function(index, item) {___jdce_logger("/js/libs/lavaca.js", 297);
            var $el = $(item),
              childView;
            if (!$el.data('view')) {
     ...
     * @return {Lavaca.mvc.View}  This view (for chaining)
     */
    mapChildView: function(selector, TView, model) {___jdce_logger("/js/libs/lavaca.js", 298);
      if (typeof selector === 'object') {
     ...
     */
    mapChildViewEvent: function(type, callback, TView) {___jdce_logger("/js/libs/lavaca.js", 299);
     ...
     *
     */
    applyChildViewEvents: function() {___jdce_logger("/js/libs/lavaca.js", 300);
      var childViewEventMap = this.childViewEventMap,
        type;
      for (type in childViewEventMap) {
        this.childViews.each(function(key, item) {___jdce_logger("/js/libs/lavaca.js", 301);
          var callbacks,
            callback,
            i = -1;
     ...
     */
    onRenderSuccess: function(e) {___jdce_logger("/js/libs/lavaca.js", 302);
      this.el.html(e.html);
     ...
     */
    onRenderError: function(e) {___jdce_logger("/js/libs/lavaca.js", 303);
      log(e.err);
    },
    /**
     ...
     * @method dispose
     */
    dispose: function() {___jdce_logger("/js/libs/lavaca.js", 304);
      if (this.model) {
...
define('lavaca/mvc/PageView',['require','$','lavaca/mvc/Model','lavaca/mvc/View','lavaca/ui/Template','lavaca/util/Promise','lavaca/util/delay'],function(require) {___jdce_logger("/js/libs/lavaca.js", 305);
   ...
   *
   */
  var PageView = View.extend(function(el, model, layer) {___jdce_logger("/js/libs/lavaca.js", 306);
     ...
     */
    wrapper: function() {___jdce_logger("/js/libs/lavaca.js", 307);
     ...
     */
    interior: function() {___jdce_logger("/js/libs/lavaca.js", 308);
     ...
     */
    insertInto: function(container) {___jdce_logger("/js/libs/lavaca.js", 309);
     ...
     * @return {Lavaca.util.Promise}  A promise
     */
    render: function() {___jdce_logger("/js/libs/lavaca.js", 310);
      var promise = new Promise(this),
          renderPromise = new Promise(this),
          template = Template.get(this.template),
          model = this.model;
      ...
      promise
        .success(function(html) {___jdce_logger("/js/libs/lavaca.js", 311);
          /**
           * Fires when html from template has rendered
           * @event rendersuccess
           */
        ...
        .error(function(err) {___jdce_logger("/js/libs/lavaca.js", 312);
          /**
           * Fired when there was an error during rendering process
           * @event rendererror
           */
     ...
     * @return {lavaca.util.Promise}  A promise
     */
    enter: function(container) {___jdce_logger("/js/libs/lavaca.js", 313);
      var promise = new Promise(this),
          renderPromise;
      container = $(container);
      if (!this.hasRendered) {
      ...
      promise.then(function() {___jdce_logger("/js/libs/lavaca.js", 314);
        /**
         * Fired when there was an error during rendering process
         * @event rendererror
         */
     ...
     * @return {lavaca.util.Promise}  A promise
     */
    exit: function() {___jdce_logger("/js/libs/lavaca.js", 315);
      var promise = new Promise(this);
      this.shell.detach();
      delay(promise.resolver());
      promise.then(function() {___jdce_logger("/js/libs/lavaca.js", 316);
        /**
         * Fired when there was an error during rendering process
         * @event rendererror
         */
...
define('lavaca/mvc/ViewManager',['require','$','lavaca/mvc/PageView','lavaca/util/ArrayUtils','lavaca/util/Cache','lavaca/util/Disposable','lavaca/util/Promise','lavaca/util/delay','mout/object/merge','lavaca/net/History'],function(require) {___jdce_logger("/js/libs/lavaca.js", 317);
   ...
   */
  var ViewManager = Disposable.extend(function(el) {___jdce_logger("/js/libs/lavaca.js", 318);
    Disposable.call(this);
    /**
    * The element that contains all view layers
     ...
     * @return {Lavaca.mvc.ViewManager}  This View Manager instance
     */
    setEl: function(el) {___jdce_logger("/js/libs/lavaca.js", 319);
     ...
     * @return {Lavaca.util.Promise}  A promise
     */
    load: function(cacheKey, TPageView, model, params) {___jdce_logger("/js/libs/lavaca.js", 320);
      if (this.locked) {
        return (new Promise(this)).reject('locked');
      } else {
        this.locked = true;
      ...
      var self = this,
          ...
          renderPromise = null,
          exitPromise = null;
      promise.always(function() {___jdce_logger("/js/libs/lavaca.js", 321);
        this.locked = false;
      });
      ...
      function lastly() {___jdce_logger("/js/libs/lavaca.js", 322);
        self.enteringPageViews = [pageView];
        promise.success(function() {___jdce_logger("/js/libs/lavaca.js", 323);
          delay(function() {___jdce_logger("/js/libs/lavaca.js", 324);
     ...
     */
    dismiss: function(layer) {___jdce_logger("/js/libs/lavaca.js", 325);
     ...
     * @return {Lavaca.util.Promise}  A promise
     */
    dismissLayersAbove: function(index, exceptForView) {___jdce_logger("/js/libs/lavaca.js", 326);
      var promise = new Promise(this),
      ...
      for (i = this.layers.length - 1; i > index; i--) {
        if ((layer = this.layers[i]) && (!exceptForView || exceptForView !== layer)) {
          (function(layer) {___jdce_logger("/js/libs/lavaca.js", 327);
            this.exitingPageViews.push(layer);
            promise
              .when(layer.exit(this.el, this.enteringPageViews))
              .success(function() {___jdce_logger("/js/libs/lavaca.js", 328);
                delay(function() {___jdce_logger("/js/libs/lavaca.js", 329);
     ...
     * @method flush
     */
    flush: function(cacheKey) {___jdce_logger("/js/libs/lavaca.js", 330);
     ...
     * @method dispose
     */
    dispose: function() {___jdce_logger("/js/libs/lavaca.js", 331);
...
define('lavaca/env/ChildBrowser',['require','lavaca/env/Device','lavaca/events/EventDispatcher','lavaca/util/Promise'],function(require) {___jdce_logger("/js/libs/lavaca.js", 332);
  ...
  var ChildBrowser = EventDispatcher.extend({
     ...
     * @return {Lavaca.util.Promise}  A promise
     */
    showWebPage: function(loc) {___jdce_logger("/js/libs/lavaca.js", 333);
      if (Device.isCordova()) {
        return Device
          .exec('ChildBrowser', 'showWebPage', [loc])
          .error(function() {___jdce_logger("/js/libs/lavaca.js", 334);
            window.location.href = loc;
          });
      } else {
        window.open(loc);
     ...
     * @return {Lavaca.util.Promise}  A promise
     */
    close: function() {___jdce_logger("/js/libs/lavaca.js", 335);
      return Device.exec('ChildBrowser', 'close', []);
    }
  });
...
define('lavaca/util/Translation',['require','./Cache','./Map'],function(require) {___jdce_logger("/js/libs/lavaca.js", 336);
  ...
  function _construct(name, src, code) {___jdce_logger("/js/libs/lavaca.js", 337);
    if (code) {
      code = JSON.parse(code);
    }
   ...
   * @param {String} code  The raw string data for the map (or null if src is supplied)
   */
  var Translation = Map.extend(function(name) {___jdce_logger("/js/libs/lavaca.js", 338);
     ...
     * @return {Boolean}  True if this translation applies
     */
    is: function(language, country) {___jdce_logger("/js/libs/lavaca.js", 339);
   ...
   */
  Translation.setDefault = function(locale) {___jdce_logger("/js/libs/lavaca.js", 340);
   ...
   */
  Translation.forLocale = function(locale) {___jdce_logger("/js/libs/lavaca.js", 341);
   ...
   * @return {Lavaca.util.Translation}  The translation
   */
  Translation.get = function(locale, code) {___jdce_logger("/js/libs/lavaca.js", 342);
    if (!code) {
      code = locale;
      locale = 'default';
    }
   ...
   * @param {jQuery} scope  The element to which to limit the scan
   */
  Translation.init = function(locale, scope) {___jdce_logger("/js/libs/lavaca.js", 343);
   ...
   * @static
   */
  Translation.dispose = function() {___jdce_logger("/js/libs/lavaca.js", 344);
    Map.dispose(_cache);
  };
...
define('jquery-mobile/jquery.mobile.vmouse', [ "jquery" ], function( jQuery ) {___jdce_logger("/js/libs/lavaca.js", 345);
(function( $, window, document, undefined ) {___jdce_logger("/js/libs/lavaca.js", 346);
...
function getNativeEvent( event ) {___jdce_logger("/js/libs/lavaca.js", 347);
...
function createVirtualEvent( event, eventType ) {___jdce_logger("/js/libs/lavaca.js", 348);
...
function getVirtualBindingFlags( element ) {___jdce_logger("/js/libs/lavaca.js", 349);
...
function getClosestElementWithVirtualBinding( element, eventType ) {___jdce_logger("/js/libs/lavaca.js", 350);
	var b;
	while ( element ) {
...
function enableTouchBindings() {___jdce_logger("/js/libs/lavaca.js", 351);
	blockTouchTriggers = false;
}

function disableTouchBindings() {___jdce_logger("/js/libs/lavaca.js", 352);
	blockTouchTriggers = true;
}

function enableMouseBindings() {___jdce_logger("/js/libs/lavaca.js", 353);
	lastTouchID = 0;
...
function disableMouseBindings() {___jdce_logger("/js/libs/lavaca.js", 354);
	// When mouse bindings are disabled, our
	// touch bindings are enabled.
	enableTouchBindings();
}

function startResetTimer() {___jdce_logger("/js/libs/lavaca.js", 355);
	clearResetTimer();
	resetTimerID = setTimeout( function() {___jdce_logger("/js/libs/lavaca.js", 356);
		resetTimerID = 0;
		enableMouseBindings();
	}, $.vmouse.resetTimerDuration );
}

function clearResetTimer() {___jdce_logger("/js/libs/lavaca.js", 357);
	if ( resetTimerID ) {
...
function triggerVirtualEvent( eventType, event, flags ) {___jdce_logger("/js/libs/lavaca.js", 358);
	var ve;
...
function mouseEventCallback( event ) {___jdce_logger("/js/libs/lavaca.js", 359);
...
function handleTouchStart( event ) {___jdce_logger("/js/libs/lavaca.js", 360);
...
function handleScroll( event ) {___jdce_logger("/js/libs/lavaca.js", 361);
...
function handleTouchMove( event ) {___jdce_logger("/js/libs/lavaca.js", 362);
	if ( blockTouchTriggers ) {
		return;
	}
...
function handleTouchEnd( event ) {___jdce_logger("/js/libs/lavaca.js", 363);
	if ( blockTouchTriggers ) {
		return;
	}
...
function hasVirtualBindings( ele ) {___jdce_logger("/js/libs/lavaca.js", 364);
...
function dummyMouseHandler() {___jdce_logger("/js/libs/lavaca.js", 365);}

function getSpecialEventObject( eventType ) {___jdce_logger("/js/libs/lavaca.js", 366);
	var realType = eventType.substr( 1 );

	return {
		setup: function( data, namespace ) {___jdce_logger("/js/libs/lavaca.js", 367);
		...
		teardown: function( data, namespace ) {___jdce_logger("/js/libs/lavaca.js", 368);
...
if ( eventCaptureSupported ) {
	document.addEventListener( "click", function( e ) {___jdce_logger("/js/libs/lavaca.js", 369);
...
//>>label: Namespace
//>>group: Core
define('jquery-mobile/jquery.mobile.ns',[ "jquery" ], function( jQuery ) {___jdce_logger("/js/libs/lavaca.js", 370);
(function( $ ) {___jdce_logger("/js/libs/lavaca.js", 371);
	$.mobile = {};
}( jQuery ));
});
...
define('jquery-mobile/jquery.mobile.support.touch', [ "jquery", "./jquery.mobile.ns" ], function( jQuery ) {___jdce_logger("/js/libs/lavaca.js", 372);
	(function( $, undefined ) {___jdce_logger("/js/libs/lavaca.js", 373);
		var support = {
...
define('jquery-mobile/events/touch', [ "jquery", "../jquery.mobile.vmouse", "../jquery.mobile.support.touch" ], function( jQuery ) {___jdce_logger("/js/libs/lavaca.js", 374);

(function( $, window, undefined ) {___jdce_logger("/js/libs/lavaca.js", 375);
	...
	$.each( ( "touchstart touchmove touchend " +
		...
		"scrollstart scrollstop" ).split( " " ), function( i, name ) {___jdce_logger("/js/libs/lavaca.js", 376);

		$.fn[ name ] = function( fn ) {___jdce_logger("/js/libs/lavaca.js", 377);
	...
	function triggerCustomEvent( obj, eventType, event ) {___jdce_logger("/js/libs/lavaca.js", 378);
	...
	$.event.special.scrollstart = {
		...
		setup: function() {___jdce_logger("/js/libs/lavaca.js", 379);
			...
			function trigger( event, state ) {___jdce_logger("/js/libs/lavaca.js", 380);
				scrolling = state;
				triggerCustomEvent( thisObject, scrolling ? "scrollstart" : "scrollstop", event );
			}

			// iPhone triggers scroll after a small delay; use touchmove instead
			$this.bind( scrollEvent, function( event ) {___jdce_logger("/js/libs/lavaca.js", 381);
				...
				clearTimeout( timer );
				timer = setTimeout( function() {___jdce_logger("/js/libs/lavaca.js", 382);
					trigger( event, false );
				}, 50 );
			});
		}
	...
	$.event.special.tap = {
		...
		setup: function() {___jdce_logger("/js/libs/lavaca.js", 383);
			var thisObject = this,
				$this = $( thisObject );

			$this.bind( "vmousedown", function( event ) {___jdce_logger("/js/libs/lavaca.js", 384);
				...
				function clearTapTimer() {___jdce_logger("/js/libs/lavaca.js", 385);
					clearTimeout( timer );
				}

				function clearTapHandlers() {___jdce_logger("/js/libs/lavaca.js", 386);
					clearTapTimer();
				...
				function clickHandler( event ) {___jdce_logger("/js/libs/lavaca.js", 387);
					clearTapHandlers();
				...
				timer = setTimeout( function() {___jdce_logger("/js/libs/lavaca.js", 388);
	...
	$.event.special.swipe = {
		...
		start: function( event ) {___jdce_logger("/js/libs/lavaca.js", 389);
		...
		stop: function( event ) {___jdce_logger("/js/libs/lavaca.js", 390);
			var data = event.originalEvent.touches ?
					event.originalEvent.touches[ 0 ] : event;
			return {
						time: ( new Date() ).getTime(),
		...
		handleSwipe: function( start, stop ) {___jdce_logger("/js/libs/lavaca.js", 391);
		...
		setup: function() {___jdce_logger("/js/libs/lavaca.js", 392);
			var thisObject = this,
				$this = $( thisObject );

			$this.bind( touchStartEvent, function( event ) {___jdce_logger("/js/libs/lavaca.js", 393);
				var start = $.event.special.swipe.start( event ),
					stop;

				function moveHandler( event ) {___jdce_logger("/js/libs/lavaca.js", 394);
					if ( !start ) {
						return;
					}
				...
				$this.bind( touchMoveEvent, moveHandler )
					.one( touchStopEvent, function() {___jdce_logger("/js/libs/lavaca.js", 395);
	...
	$.each({
		...
		swipeleft: "swipe",
		swiperight: "swipe"
	}, function( event, sourceEvent ) {___jdce_logger("/js/libs/lavaca.js", 396);

		$.event.special[ event ] = {
			setup: function() {___jdce_logger("/js/libs/lavaca.js", 397);
...
define('jquery-mobile/jquery.mobile.support.orientation', [ "jquery" ], function( jQuery ) {___jdce_logger("/js/libs/lavaca.js", 398);
	(function( $, undefined ) {___jdce_logger("/js/libs/lavaca.js", 399);
		$.extend( $.support, {
...
define('jquery-mobile/events/throttledresize', [ "jquery" ], function( jQuery ) {___jdce_logger("/js/libs/lavaca.js", 400);

	// throttled resize event
	(function( $ ) {___jdce_logger("/js/libs/lavaca.js", 401);
		$.event.special.throttledresize = {
			setup: function() {___jdce_logger("/js/libs/lavaca.js", 402);
				$( this ).bind( "resize", handler );
			},
			teardown: function() {___jdce_logger("/js/libs/lavaca.js", 403);
				$( this ).unbind( "resize", handler );
			}
		};

		var throttle = 250,
			handler = function() {___jdce_logger("/js/libs/lavaca.js", 404);
...
define('jquery-mobile/events/orientationchange', [ "jquery", "../jquery.mobile.support.orientation", "./throttledresize" ], function( jQuery ) {___jdce_logger("/js/libs/lavaca.js", 405);

(function( $, window ) {___jdce_logger("/js/libs/lavaca.js", 406);
	var win = $( window ),
	...
	$.event.special.orientationchange = $.extend( {}, $.event.special.orientationchange, {
		setup: function() {___jdce_logger("/js/libs/lavaca.js", 407);
		...
		teardown: function() {___jdce_logger("/js/libs/lavaca.js", 408);
		...
		add: function( handleObj ) {___jdce_logger("/js/libs/lavaca.js", 409);
			// Save a reference to the bound event handler.
			var old_handler = handleObj.handler;


			handleObj.handler = function( event ) {___jdce_logger("/js/libs/lavaca.js", 410);
	...
	function handler() {___jdce_logger("/js/libs/lavaca.js", 411);
	...
	$.event.special.orientationchange.orientation = get_orientation = function() {___jdce_logger("/js/libs/lavaca.js", 412);
	...
	$.fn[ event_name ] = function( fn ) {___jdce_logger("/js/libs/lavaca.js", 413);
...
define('lavaca/mvc/Application',['require','$','lavaca/net/History','lavaca/env/Device','lavaca/events/EventDispatcher','lavaca/mvc/Router','lavaca/mvc/ViewManager','lavaca/net/Connectivity','lavaca/ui/Template','lavaca/util/Config','lavaca/util/Promise','lavaca/env/ChildBrowser','lavaca/util/Translation','jquery-mobile/events/touch','jquery-mobile/events/orientationchange'],function(require) {___jdce_logger("/js/libs/lavaca.js", 414);
  ...
  function _stopEvent(e) {___jdce_logger("/js/libs/lavaca.js", 415);
    e.preventDefault();
    e.stopPropagation();
  }

  function _matchHashRoute(hash) {___jdce_logger("/js/libs/lavaca.js", 416);
   ...
   */
  var Application = EventDispatcher.extend(function(callback) {___jdce_logger("/js/libs/lavaca.js", 417);
    if (callback) {
      this._callback = callback.bind(this);
    }
    Device.init(function() {___jdce_logger("/js/libs/lavaca.js", 418);
     ...
     */
    onInvalidRoute: function(err) {___jdce_logger("/js/libs/lavaca.js", 419);
     ...
     */
    onTapLink: function(e) {___jdce_logger("/js/libs/lavaca.js", 420);
     ...
     * @return {Lavaca.util.Promise}  A promise
     */
    ajax: function() {___jdce_logger("/js/libs/lavaca.js", 421);
     ...
     */
    init: function(args) {___jdce_logger("/js/libs/lavaca.js", 422);
      var promise = new Promise(this),
          _cbPromise,
          lastly;
      Template.init();
      ...
      lastly = function() {___jdce_logger("/js/libs/lavaca.js", 423);
      ...
      return promise.then(function() {___jdce_logger("/js/libs/lavaca.js", 424);
        this.trigger('ready');
      });
    },
    ...
    initialHashRoute: (function(hash) {___jdce_logger("/js/libs/lavaca.js", 425);
     ...
     * @return {Lavaca.util.Promise}  A promise
     */
    beforeInit: function(Config) {___jdce_logger("/js/libs/lavaca.js", 426);
      var promise = new Promise();
...
define('lavaca/mvc/Collection',['require','lavaca/mvc/Model','lavaca/net/Connectivity','lavaca/util/ArrayUtils','lavaca/util/Promise','mout/lang/deepClone','mout/object/merge'],function(require) {___jdce_logger("/js/libs/lavaca.js", 427);
  ...
  function _triggerItemEvent(collection, event, previousIndex, index, model) {___jdce_logger("/js/libs/lavaca.js", 428);
  ...
  function _getComparator(attr, descending) {___jdce_logger("/js/libs/lavaca.js", 429);
    var compareVal = descending ? 1 : -1;
    return function(modelA, modelB) {___jdce_logger("/js/libs/lavaca.js", 430);
   ...
   */
  var Collection = Model.extend(function(models, map) {___jdce_logger("/js/libs/lavaca.js", 431);
    Model.call(this, map);
    this.models = [];
   ...
   itemsProperty: 'items',
     ...
     */
//  @event removeItem
    clear: function() {___jdce_logger("/js/libs/lavaca.js", 432);
     ...
     *
     */
    clearModels: function() {___jdce_logger("/js/libs/lavaca.js", 433);
      var i = -1,
          model;
     ...
     */
    prepare: function(data) {___jdce_logger("/js/libs/lavaca.js", 434);
     ...
     * @return {Boolean}  True if you can assign to the attribute
     */
    canSet: function(attribute) {___jdce_logger("/js/libs/lavaca.js", 435);
...
//@event addItem
    ...
    insert: function(insertIndex, item /*, item1, item2, item3...*/) {___jdce_logger("/js/libs/lavaca.js", 436);
      var result = false,
     ...
     */
// * @event addItem
    add: function(/* item1, item2, itemN */) {___jdce_logger("/js/libs/lavaca.js", 437);
     ...
     */
// * @event moveItem
    moveTo: function(oldIndex, newIndex) {___jdce_logger("/js/libs/lavaca.js", 438);
...
//* @event removeItem
    ...
    remove: function(item /*, item1, item2, item3...*/) {___jdce_logger("/js/libs/lavaca.js", 439);
     ...
     * @return {Array}  A list of this collection's models that passed the test
     */
    filter: function(test, maxResults) {___jdce_logger("/js/libs/lavaca.js", 440);
      ...
      if (typeof test !== 'function') {
        attrs = test;
        test = function(index, item) {___jdce_logger("/js/libs/lavaca.js", 441);
          for (var n in attrs) {
     ...
     */
    first: function(test) {___jdce_logger("/js/libs/lavaca.js", 442);
     ...
     * @return {Number}  Index of the matching model, or -1 if no match is found
     */
    indexOf: function(test) {___jdce_logger("/js/libs/lavaca.js", 443);
     ...
     */
    itemAt: function(index) {___jdce_logger("/js/libs/lavaca.js", 444);
     ...
     */
    count: function() {___jdce_logger("/js/libs/lavaca.js", 445);
     ...
     * @param {Object} thisp  The context of the callback
     */
    each: function(cb, thisp) {___jdce_logger("/js/libs/lavaca.js", 446);
      var i = -1,
          returned,
          item;
...
//* @event moveItem
    ...
    sort: function(attribute, descending) {___jdce_logger("/js/libs/lavaca.js", 447);
      ...
      if (!this.suppressEvents) {
        this.each(function(index, model) {___jdce_logger("/js/libs/lavaca.js", 448);
     ...
     */
//* @event moveItem
    reverse: function() {___jdce_logger("/js/libs/lavaca.js", 449);
      ...
      if (!this.suppressEvents) {
        this.each(function(index, model) {___jdce_logger("/js/libs/lavaca.js", 450);
          oldIndex = ArrayUtils.indexOf(oldModels, model);
          if (oldIndex !== index) {
            _triggerItemEvent(this, 'moveItem', ArrayUtils.indexOf(oldModels, model), index, model);
          }
     ...
     */
    onItemEvent: function(e) {___jdce_logger("/js/libs/lavaca.js", 451);
      var model = e.target,
          index = ArrayUtils.indexOf(this.models, model);
      if (e.type === 'change') {
     ...
     * @param {Object} response  The response data
     */
    onFetchSuccess: function(response) {___jdce_logger("/js/libs/lavaca.js", 452);
      var list;
      response = this.parse(response);
      if (this.responseFilter && typeof this.responseFilter === 'function') {
        response = this.responseFilter(response);
     ...
     * @return {Lavaca.util.Promise}  A promise
     */
    saveToServer: function(url) {___jdce_logger("/js/libs/lavaca.js", 453);
      return this.save(function(model, changedAttributes, attributes) {___jdce_logger("/js/libs/lavaca.js", 454);
        var id = this.id(),
            data;
        if (this.isNew()) {
          data = attributes;
     ...
     * @return {Object}  The key-value hash
     */
    toObject: function(idOnly) {___jdce_logger("/js/libs/lavaca.js", 455);
    ...
    */
    responseFilter: function(response) {___jdce_logger("/js/libs/lavaca.js", 456);
      return response;
    }
  });
...
define('lavaca/util/StringUtils',['require'],function(require) {___jdce_logger("/js/libs/lavaca.js", 457);
  ...
  function _noop(s) {___jdce_logger("/js/libs/lavaca.js", 458);
    return s;
  }
   ...
   * @return {String}  The format string with the arguments substituted into it
   */
  StringUtils.format = function(s /*[, arg0, arg1, argN]*/) {___jdce_logger("/js/libs/lavaca.js", 459);
    var args,
        fn = _noop,
        i,
        j;
   ...
   */
  StringUtils.escapeHTML = function(s) {___jdce_logger("/js/libs/lavaca.js", 460);
    s = '' + s;
...
define('lavaca/mvc/Controller',['require','lavaca/net/Connectivity','lavaca/net/History','lavaca/util/Disposable','lavaca/util/Promise','lavaca/util/StringUtils','lavaca/util/Translation'],function(require) {___jdce_logger("/js/libs/lavaca.js", 461);
   ...
   */
  var Controller = Disposable.extend(function(router, viewManager) {___jdce_logger("/js/libs/lavaca.js", 462);
     ...
     * @return {Lavaca.util.Promise}  A promise
     */
    exec: function(action, params, state) {___jdce_logger("/js/libs/lavaca.js", 463);
      this.params = params;
      this.state = state;
      var promise = new Promise(this),
          model,
      ...
      if (state) {
        model = state.state;
        promise.success(function() {___jdce_logger("/js/libs/lavaca.js", 464);
     ...
     * @return {Lavaca.util.Promise}  A promise
     */
    view: function(cacheKey, TView, model, layer) {___jdce_logger("/js/libs/lavaca.js", 465);
     ...
     */
    history: function(state, title, url, useReplace) {___jdce_logger("/js/libs/lavaca.js", 466);
      var needsHistory = !this.state;
      return function() {___jdce_logger("/js/libs/lavaca.js", 467);
        if (needsHistory) {
     ...
     */
    url: function(str, args) {___jdce_logger("/js/libs/lavaca.js", 468);
     ...
     * @return {Lavaca.util.Promise}  A promise
     */
    redirect: function(str, args) {___jdce_logger("/js/libs/lavaca.js", 469);
     ...
     * @method dispose
     */
    dispose: function() {___jdce_logger("/js/libs/lavaca.js", 470);
...
define('lavaca/mvc/Model',['require','lavaca/events/EventDispatcher','lavaca/net/Connectivity','lavaca/util/ArrayUtils','lavaca/util/Cache','lavaca/util/Promise','mout/lang/deepClone','mout/object/merge','lavaca/util/Config'],function(require) {___jdce_logger("/js/libs/lavaca.js", 471);
  ...
  function _triggerAttributeEvent(model, event, attribute, previous, value, messages) {___jdce_logger("/js/libs/lavaca.js", 472);
    model.trigger(event, {
      attribute: attribute,
      previous: previous === UNDEFINED ? null : previous,
      value: value === UNDEFINED ? model.get(attribute) : value,
  ...
  function _setFlagOn(model, name, flag) {___jdce_logger("/js/libs/lavaca.js", 473);
    var keys = model.flags[flag];
    if (!keys) {
      keys = model.flags[flag] = [];
    }
  ...
  function _suppressChecked(model, suppress, callback) {___jdce_logger("/js/libs/lavaca.js", 474);
    suppress = !!suppress;
    var props = ['suppressValidation', 'suppressEvents', 'suppressTracking'],
        old = {},
        i = -1,
  ...
  function _isValid(messages){___jdce_logger("/js/libs/lavaca.js", 475);
    var isValid = true;
    for(var attribute in messages){
      if (messages[attribute].length > 0){
        isValid = false;
   ...
   * @param {Object} [map]  A parameter hash to apply to the model
   */
  var Model = EventDispatcher.extend(function(map) {___jdce_logger("/js/libs/lavaca.js", 476);
    EventDispatcher.call(this);
    this.attributes = new Cache();
    this.rules = new Cache();
    this.unsavedAttributes = [];
     ...
     * @return {Object}  The value of the attribute, or null if there is no value
     */
    get: function(attribute) {___jdce_logger("/js/libs/lavaca.js", 477);
      var attr = this.attributes.get(attribute),
          flags;
      if (typeof attr === 'function') {
        flags = this.flags[Model.DO_NOT_COMPUTE];
     ...
     * @return {Boolean}  True if you can assign to the attribute
     */
    canSet: function() {___jdce_logger("/js/libs/lavaca.js", 478);
      return true;
    },
    /**
     * Sets the value of the attribute, if it passes validation
...
//* @event change
    ...
    set: function(attribute, value, flag, suppress) {___jdce_logger("/js/libs/lavaca.js", 479);
      return _suppressChecked(this, suppress, function() {___jdce_logger("/js/libs/lavaca.js", 480);
        if (!this.canSet(attribute)) {
          return false;
        }
        var previous = this.attributes.get(attribute),
     ...
     * @return {Boolean}  True if the attribute exists and has a value
     */
    has: function(attribute) {___jdce_logger("/js/libs/lavaca.js", 481);
      return this.get(attribute) !== null;
    },
    /**
     * The name of the ID attribute
     ...
     * @return {String}  The ID of the model
     */
    id: function() {___jdce_logger("/js/libs/lavaca.js", 482);
      return this.get(this.idAttribute);
    },
    /**
     * Determines whether or not this model has been saved before
     ...
     * @return {Boolean}  True when the model has no ID associated with it
     */
    isNew: function() {___jdce_logger("/js/libs/lavaca.js", 483);
      return null === this.id();
    },
    /**
     * Ensures that a map is suitable to be applied to this model
     ...
     * @return {Object}  The parsed version of the map
     */
    parse: function(map) {___jdce_logger("/js/libs/lavaca.js", 484);
      if (typeof map === 'string') {
        map = JSON.parse(map);
      }
      return map;
     ...
     * @param {Boolean} suppress  When true, validation, events and tracking are suppressed
     */
    apply: function(map, suppress) {___jdce_logger("/js/libs/lavaca.js", 485);
      _suppressChecked(this, suppress, function() {___jdce_logger("/js/libs/lavaca.js", 486);
        map = this.parse(map);
        for (var n in map) {
          this.set(n, map[n]);
        }
     ...
     * @param {String} flag  The metadata flag describing the data to remove
     */
    clear: function(flag) {___jdce_logger("/js/libs/lavaca.js", 487);
      if (flag) {
        var attrs = this.flags[flag],
            i = -1,
            attr,
     ...
     * @return {Lavaca.mvc.Model}  The copy
     */
    clone: function() {___jdce_logger("/js/libs/lavaca.js", 488);
      return new this.constructor(this.attributes.toObject());
    },
    /**
     * Adds a validation rule to this model
     ...
     * @param {String} message  A text message used when a value fails the test
     */
    addRule: function(attribute, callback, message) {___jdce_logger("/js/libs/lavaca.js", 489);
      this.rules.get(attribute, []).push({rule: callback, message: message});
    },
    /**
     * Validates all attributes on the model
     ...
     * @return {Array}  A list of validation error messages
     */
    validate: function(attribute, value) {___jdce_logger("/js/libs/lavaca.js", 490);
      var messages,
          rules,
          i = -1,
          rule;
      if (attribute) {
        ...
        messages = {};
        this.rules.each(function(attributeName) {___jdce_logger("/js/libs/lavaca.js", 491);
          messages[attributeName] = this.validate(attributeName);
        }, this);
        return _isValid(messages);
      }
     ...
     * @param {Object} response  The response data
     */
    onFetchSuccess: function(response) {___jdce_logger("/js/libs/lavaca.js", 492);
      response = this.parse(response);
      if (this.responseFilter && typeof this.responseFilter === 'function') {
        response = this.responseFilter(response);
      }
     ...
     * @param {Object} value  The error value
     */
    onFetchError: function(response) {___jdce_logger("/js/libs/lavaca.js", 493);
      this.trigger('fetchError', {response: response});
    },
    /**
     * Loads the data for this model from the server and only apply to this model attributes (Note: Does not clear the model first)
     ...
     * @return {Lavaca.util.Promise}  A promise
     */
    fetch: function(url, options) {___jdce_logger("/js/libs/lavaca.js", 494);
      if (typeof url === 'object') {
        options = url;
      } else {
        options = clone(options || {});
     ...
     * @return {String}  A formated api url or an apparently bad url '/please_set_model_url' if relPath argument is faslsy
     */
    getApiURL: function(relPath) {___jdce_logger("/js/libs/lavaca.js", 495);
      var badURL = '/please_set_model_url',
          apiRoot = Config.get('apiRoot'),
          apiURL;
      if (!relPath) {
...
//* @event saveError
    ...
    save: function(callback, thisp) {___jdce_logger("/js/libs/lavaca.js", 496);
      var promise = new Promise(this),
          attributes = this.toObject(),
          changedAttributes = {},
          i = -1,
      ...
      promise
        .success(function(value) {___jdce_logger("/js/libs/lavaca.js", 497);
          var idAttribute = this.idAttribute;
          if (this.isNew() && value[idAttribute] !== UNDEFINED) {
            this.set(idAttribute, value[idAttribute]);
          }
        ...
        .error(function(value) {___jdce_logger("/js/libs/lavaca.js", 498);
          this.trigger('saveError', {response: value});
        });
      result = callback.call(thisp || this, this, changedAttributes, attributes);
      if (result instanceof Promise) {
     ...
     * @return {Lavaca.util.Promise}  A promise
     */
    saveToServer: function(url) {___jdce_logger("/js/libs/lavaca.js", 499);
      return this.save(function(model, changedAttributes, attributes) {___jdce_logger("/js/libs/lavaca.js", 500);
        var id = this.id(),
            data;
        if (this.isNew()) {
          data = attributes;
     ...
     * @return {Object}  The key-value hash
     */
    toObject: function() {___jdce_logger("/js/libs/lavaca.js", 501);
      var obj = this.attributes.toObject(),
          flags;
      for(var key in obj) {
        if(typeof obj[key] === "function") {
     ...
     * @return {String}  The JSON string representing the model
     */
    toJSON: function() {___jdce_logger("/js/libs/lavaca.js", 502);
      return JSON.stringify(this.toObject());
    },
    /**
     * Bind an event handler to this object
     ...
     * @return {Lavaca.events.EventDispatcher}  This event dispatcher (for chaining)
     */
    on: function(type, attr, callback, thisp) {___jdce_logger("/js/libs/lavaca.js", 503);
      if (typeof attr === 'function') {
        thisp = callback;
        callback = attr;
        attr = null;
      }
      function handler(e) {___jdce_logger("/js/libs/lavaca.js", 504);
        if (!attr || e.attribute === attr) {
          callback.call(thisp || this, e);
        }
      }
    ...
    * @return {Object}  An object to be applied to this model instance
    */
    responseFilter: function(response) {___jdce_logger("/js/libs/lavaca.js", 505);
      return response;
    }
  });
  /**
...
define('lavaca/mvc/PageView',['require','$','lavaca/mvc/Model','lavaca/mvc/View','lavaca/ui/Template','lavaca/util/Promise','lavaca/util/delay'],function(require) {___jdce_logger("/js/libs/lavaca.js", 506);
   ...
   *
   */
  var PageView = View.extend(function(el, model, layer) {___jdce_logger("/js/libs/lavaca.js", 507);
     ...
     * @return {jQuery}  The wrapper element
     */
    wrapper: function() {___jdce_logger("/js/libs/lavaca.js", 508);
      return $('<div class="view"></div>');
    },
    /**
     * Creates the view's interior content wrapper element
     ...
     * @return {jQuery} The interior content wrapper element
     */
    interior: function() {___jdce_logger("/js/libs/lavaca.js", 509);
      return $('<div class="view-interior"></div>');
    },
     ...
     * @param {jQuery} container  The containing element
     */
    insertInto: function(container) {___jdce_logger("/js/libs/lavaca.js", 510);
      if (this.shell.parent()[0] !== container[0]) {
        var layers = container.children('[data-layer-index]'),
            i = -1,
            layer;
     ...
     * @return {Lavaca.util.Promise}  A promise
     */
    render: function() {___jdce_logger("/js/libs/lavaca.js", 511);
      var promise = new Promise(this),
          renderPromise = new Promise(this),
          template = Template.get(this.template),
          model = this.model;
      ...
      promise
        .success(function(html) {___jdce_logger("/js/libs/lavaca.js", 512);
          /**
           * Fires when html from template has rendered
           * @event rendersuccess
           */
        ...
        .error(function(err) {___jdce_logger("/js/libs/lavaca.js", 513);
          /**
           * Fired when there was an error during rendering process
           * @event rendererror
           */
     ...
     * @return {lavaca.util.Promise}  A promise
     */
    enter: function(container) {___jdce_logger("/js/libs/lavaca.js", 514);
      var promise = new Promise(this),
          renderPromise;
      container = $(container);
      if (!this.hasRendered) {
      ...
      promise.then(function() {___jdce_logger("/js/libs/lavaca.js", 515);
        /**
         * Fired when there was an error during rendering process
         * @event rendererror
         */
     ...
     * @return {lavaca.util.Promise}  A promise
     */
    exit: function() {___jdce_logger("/js/libs/lavaca.js", 516);
      var promise = new Promise(this);
      this.shell.detach();
      delay(promise.resolver());
      promise.then(function() {___jdce_logger("/js/libs/lavaca.js", 517);
        /**
         * Fired when there was an error during rendering process
         * @event rendererror
         */
...
define('lavaca/mvc/Route',['require','lavaca/util/Disposable','lavaca/util/delay','mout/lang/deepClone','mout/object/merge'],function(require) {___jdce_logger("/js/libs/lavaca.js", 518);
  ...
  function _multivariablePattern() {___jdce_logger("/js/libs/lavaca.js", 519);
    return new RegExp('\\{\\*(.*?)\\}', 'g');
  }

  function _variablePattern() {___jdce_logger("/js/libs/lavaca.js", 520);
    return new RegExp('\\{([^\\/]*?)\\}', 'g');
  }

  function _variableCharacters() {___jdce_logger("/js/libs/lavaca.js", 521);
    return new RegExp('[\\{\\}\\*]', 'g');
  }

  function _datePattern() {___jdce_logger("/js/libs/lavaca.js", 522);
    return new RegExp('^\\d{4}-[0-1]\\d-[0-3]\\d$', 'g');
  }

  function _patternToRegExp(pattern) {___jdce_logger("/js/libs/lavaca.js", 523);
    if (pattern === '/') {
      return new RegExp('^\\/(\\?.*)?(#.*)?$', 'g');
    }
    if (pattern.charAt(0) === '/') {
  ...
  function _scrubURLValue(value) {___jdce_logger("/js/libs/lavaca.js", 524);
    value = decodeURIComponent(value);
    if (!isNaN(value)) {
      value = Number(value);
    } else if (value.toLowerCase() === 'true') {
   ...
   *   object that is passed to the controller action
   */
  var Route = Disposable.extend(function(pattern, TController, action, params) {___jdce_logger("/js/libs/lavaca.js", 525);
    Disposable.call(this);
    this.pattern = pattern;
    this.TController = TController;
    this.action = action;
     ...
     * @return {Boolean}  True when this route matches the URL
     */
    matches: function(url) {___jdce_logger("/js/libs/lavaca.js", 526);
      return _patternToRegExp(this.pattern).test(url);
    },
    /**
     * Converts a URL into a params object according to this route's pattern
     ...
     * @return {Object}  The params object
     */
    parse: function(url) {___jdce_logger("/js/libs/lavaca.js", 527);
      var result = clone(this.params),
          pattern = this.pattern.slice(1),
          urlParts = url.split('#'),
          i,
     ...
     * @return {Lavaca.util.Promise}  A promise
     */
    exec: function(url, router, viewManager, state, params) {___jdce_logger("/js/libs/lavaca.js", 528);
      var controller = new this.TController(router, viewManager),
          urlParams = this.parse(url),
          promise = controller.exec(this.action, merge(urlParams, params), state);
      function dispose() {___jdce_logger("/js/libs/lavaca.js", 529);
        delay(controller.dispose, controller);
      }
      promise.then(dispose, dispose);
      return promise;
...
define('lavaca/mvc/Router',['require','./Route','lavaca/net/History','lavaca/util/Disposable','lavaca/util/Promise'],function(require) {___jdce_logger("/js/libs/lavaca.js", 530);
   ...
   * @param {Lavaca.mvc.ViewManager} viewManager  The view manager
   */
  var Router = Disposable.extend(function(viewManager) {___jdce_logger("/js/libs/lavaca.js", 531);
    Disposable.call(this);
    /**
     * @field {Array} routes
     * @default []
    ...
    startHistory: function() {___jdce_logger("/js/libs/lavaca.js", 532);
      this.onpopstate = function(e) {___jdce_logger("/js/libs/lavaca.js", 533);
        if (this.hasNavigated) {
          History.isRoutingBack = e.direction === 'back';
          this.exec(e.url, e).always(function() {___jdce_logger("/js/libs/lavaca.js", 534);
            History.isRoutingBack = false;
          });
        }
      };
     ...
     * @return {Lavaca.mvc.Router}  This Router instance
     */
    setViewManager: function(viewManager) {___jdce_logger("/js/libs/lavaca.js", 535);
      this.viewManager = viewManager;
      return this;
    },
    /**
     ...
     * @return {Lavaca.mvc.Router}  The router (for chaining)
     */
    add: function(pattern, TController, action, params) {___jdce_logger("/js/libs/lavaca.js", 536);
      if (typeof pattern === 'object') {
        for (var p in pattern) {
          var args = pattern[p];
          if (args instanceof Array) {
     ...
     * @return {Lavaca.util.Promise}  A promise
     */
    exec: function(url, state, params) {___jdce_logger("/js/libs/lavaca.js", 537);
      if (this.locked) {
        return (new Promise(this)).reject('locked');
      } else {
        this.locked = true;
      ...
      var i = -1,
          route,
          promise = new Promise(this);
      promise.always(function() {___jdce_logger("/js/libs/lavaca.js", 538);
        this.unlock();
      });
      if (!this.hasNavigated) {
        promise.success(function() {___jdce_logger("/js/libs/lavaca.js", 539);
          this.hasNavigated = true;
        });
      }
      while (!!(route = this.routes[++i])) {
     ...
     * @return {Lavaca.mvc.Router}  This router (for chaining)
     */
    unlock: function() {___jdce_logger("/js/libs/lavaca.js", 540);
      this.locked = false;
      return this;
    },
    /**
     ...
     * @method dispose
     */
    dispose: function() {___jdce_logger("/js/libs/lavaca.js", 541);
      if (this.onpopstate) {
        History.off('popstate', this.onpopstate);
        this.onpopstate = null;
      }
...
define('lavaca/mvc/View',['require','$','lavaca/events/EventDispatcher','lavaca/mvc/Model','lavaca/ui/Template','lavaca/util/Cache','lavaca/util/Promise','lavaca/util/log','lavaca/util/uuid'],function(require) {___jdce_logger("/js/libs/lavaca.js", 542);
   ...
   *
   */
  var View = EventDispatcher.extend(function(el, model, parentView) {___jdce_logger("/js/libs/lavaca.js", 543);
    EventDispatcher.call(this);
     ...
     * @return {lavaca.util.Promise} A promise
     */
    render: function() {___jdce_logger("/js/libs/lavaca.js", 544);
      var self = this,
        promise = new Promise(this),
        renderPromise = new Promise(this),
        template = Template.get(this.template),
       ...
       */
      promise
        .success(function(html) {___jdce_logger("/js/libs/lavaca.js", 545);
          this.trigger('rendersuccess', {html: html});
          renderPromise.resolve();
        })
      /**
       ...
       * @event rendererror
       */
        .error(function(err) {___jdce_logger("/js/libs/lavaca.js", 546);
          this.trigger('rendererror', {err: err});
          renderPromise.reject();
        });
      template
        ...
        .success(promise.resolver())
        .error(promise.rejector())
        .then(function() {___jdce_logger("/js/libs/lavaca.js", 547);
          if (self.className){
            self.el.addClass(self.className);
          }
        });
     ...
     * @return {lavaca.util.Promise}  A promise
     */
    redraw: function(selector, model) {___jdce_logger("/js/libs/lavaca.js", 548);
      var self = this,
        templateRenderPromise = new Promise(this),
        redrawPromise = new Promise(this),
        template = Template.get(this.template),
      ...
      // process widget, child view, and
      // child view event maps
      function processMaps() {___jdce_logger("/js/libs/lavaca.js", 549);
        self.createWidgets();
        self.createChildViews();
        self.applyChildViewEvents();
      }
      templateRenderPromise
        .success(function(html) {___jdce_logger("/js/libs/lavaca.js", 550);
          if (replaceAll) {
            this.disposeChildViews(this.el);
            this.disposeWidgets(this.el);
            this.el.html(html);
          ...
          if(selector) {
            var $newEl = $('<div>' + html + '</div>').find(selector),
              $oldEl = this.el.find(selector);
            if($newEl.length === $oldEl.length) {
              $oldEl.each(function(index) {___jdce_logger("/js/libs/lavaca.js", 551);
                var $el = $(this);
                self.disposeChildViews($el);
                self.disposeWidgets($el);
                $el.replaceWith($newEl.eq(index)).remove();
     ...
     * @param  {Object} $el the $el to search for child views and widgets in
     */
    disposeChildViews: function ($el) {___jdce_logger("/js/libs/lavaca.js", 552);
      var childViewSearch,
        self = this;
      ...
      childViewSearch.each(function(index, item) {___jdce_logger("/js/libs/lavaca.js", 553);
        var $item = $(item),
          childView = $item.data('view');
     ...
     * @param  {Object} $el the $el to search for child views and widgets in
     */
    disposeWidgets: function ($el) {___jdce_logger("/js/libs/lavaca.js", 554);
      var self = this;

      // Remove widgets
      $el.add($el.find('[data-has-widgets]')).each(function(index, item) {___jdce_logger("/js/libs/lavaca.js", 555);
        var $item = $(item),
          widgets = $item.data('widgets'),
          selector, widget;
        for (selector in widgets) {
     ...
     *
     */
    clearModelEvents: function() {___jdce_logger("/js/libs/lavaca.js", 556);
      var type,
        callback,
        dotIndex;
      if (this.eventMap
     ...
     * @method bindMappedEvents
     */
    bindMappedEvents: function() {___jdce_logger("/js/libs/lavaca.js", 557);
      var callbacks,
        delegate,
        type;
      for (delegate in this.eventMap) {
     ...
     *
     */
    applyEvents: function() {___jdce_logger("/js/libs/lavaca.js", 558);
      var el = this.el,
        callbacks,
        callback,
        property,
     ...
     * @return {lavaca.mvc.View}  This view (for chaining)
     */
    mapEvent: function(delegate, type, callback) {___jdce_logger("/js/libs/lavaca.js", 559);
      var o;
      if (typeof delegate === 'object') {
        o = delegate;
        for (delegate in o) {
     ...
     *
     */
    createWidgets: function() {___jdce_logger("/js/libs/lavaca.js", 560);
      var cache = this.widgets,
        n,
        o;
      for (n in this.widgetMap) {
        o = this.widgetMap[n];
        (n === 'self' ? this.el : this.el.find(n))
          .each(function(index, item) {___jdce_logger("/js/libs/lavaca.js", 561);
            var $el = $(item),
              widgetMap = $el.data('widgets') || {},
              widget;
            if (!widgetMap[n]) {
     ...
     * @return {Lavaca.mvc.View}  This view (for chaining)
     */
    mapWidget: function(selector, TWidget) {___jdce_logger("/js/libs/lavaca.js", 562);
      if (typeof selector === 'object') {
        var widgetTypes = selector;
        for (selector in widgetTypes) {
          this.mapWidget(selector, widgetTypes[selector]);
     ...
     *
     */
    createChildViews: function() {___jdce_logger("/js/libs/lavaca.js", 563);
      var cache = this.childViews,
        n,
        self = this,
        o;
      for (n in this.childViewMap) {
        o = this.childViewMap[n];
        this.el.find(n)
          .each(function(index, item) {___jdce_logger("/js/libs/lavaca.js", 564);
            var $el = $(item),
              childView;
            if (!$el.data('view')) {
              childView = new o.TView($el, o.model || self.model, self);
     ...
     * @return {Lavaca.mvc.View}  This view (for chaining)
     */
    mapChildView: function(selector, TView, model) {___jdce_logger("/js/libs/lavaca.js", 565);
      if (typeof selector === 'object') {
        var childViewTypes = selector;
        for (selector in childViewTypes) {
          this.mapChildView(selector, childViewTypes[selector].TView, childViewTypes[selector].model);
     ...
     *  The map should be in the form {type : {callback : {Function}, TView : TView}}
     */
    mapChildViewEvent: function(type, callback, TView) {___jdce_logger("/js/libs/lavaca.js", 566);
      if (typeof type === 'object'){
        var eventTypes = type;
        for (type in eventTypes){
          //add in view type to limit events created
     ...
     *
     */
    applyChildViewEvents: function() {___jdce_logger("/js/libs/lavaca.js", 567);
      var childViewEventMap = this.childViewEventMap,
        type;
      for (type in childViewEventMap) {
        this.childViews.each(function(key, item) {___jdce_logger("/js/libs/lavaca.js", 568);
          var callbacks,
            callback,
            i = -1;
     ...
     *   that contains the template's rendered HTML output.
     */
    onRenderSuccess: function(e) {___jdce_logger("/js/libs/lavaca.js", 569);
      this.el.html(e.html);
      this.bindMappedEvents();
      this.applyEvents();
      this.createWidgets();
     ...
     *   that contains the error message.
     */
    onRenderError: function(e) {___jdce_logger("/js/libs/lavaca.js", 570);
      log(e.err);
    },
    /**
     * Readies the view for garbage collection
     * @method dispose
     */
    dispose: function() {___jdce_logger("/js/libs/lavaca.js", 571);
      if (this.model) {
        this.clearModelEvents();
      }
      if (this.childViews.count()) {
...
define('lavaca/mvc/ViewManager',['require','$','lavaca/mvc/PageView','lavaca/util/ArrayUtils','lavaca/util/Cache','lavaca/util/Disposable','lavaca/util/Promise','lavaca/util/delay','mout/object/merge','lavaca/net/History'],function(require) {___jdce_logger("/js/libs/lavaca.js", 572);
   ...
   * @param {jQuery} el  The element that contains all layers
   */
  var ViewManager = Disposable.extend(function(el) {___jdce_logger("/js/libs/lavaca.js", 573);
    Disposable.call(this);
    /**
    * The element that contains all view layers
     * @property {jQuery} el
     ...
     * @return {Lavaca.mvc.ViewManager}  This View Manager instance
     */
    setEl: function(el) {___jdce_logger("/js/libs/lavaca.js", 574);
      this.el = typeof el === 'string' ? $(el) : el;
      return this;
    },
    /**
     ...
     * @return {Lavaca.util.Promise}  A promise
     */
    load: function(cacheKey, TPageView, model, params) {___jdce_logger("/js/libs/lavaca.js", 575);
      if (this.locked) {
        return (new Promise(this)).reject('locked');
      } else {
        this.locked = true;
      ...
      var self = this,
          ...
          renderPromise = null,
          exitPromise = null;
      promise.always(function() {___jdce_logger("/js/libs/lavaca.js", 576);
        this.locked = false;
      });
      if (typeof params === 'number') {
        layer = params;
      ...
      function lastly() {___jdce_logger("/js/libs/lavaca.js", 577);
        self.enteringPageViews = [pageView];
        promise.success(function() {___jdce_logger("/js/libs/lavaca.js", 578);
          delay(function() {___jdce_logger("/js/libs/lavaca.js", 579);
            self.enteringPageViews = [];
          });
        });
        exitPromise = self.dismissLayersAbove(layer - 1, pageView);
     ...
     * @param {Lavaca.mvc.View} view  The view on the layer to remove
     */
    dismiss: function(layer) {___jdce_logger("/js/libs/lavaca.js", 580);
      if (typeof layer === 'number') {
        this.dismissLayersAbove(layer - 1);
      } else if (layer instanceof PageView) {
        this.dismiss(layer.layer);
     ...
     * @return {Lavaca.util.Promise}  A promise
     */
    dismissLayersAbove: function(index, exceptForView) {___jdce_logger("/js/libs/lavaca.js", 581);
      var promise = new Promise(this),
          dismissedLayers = false,
          i,
          layer;
      for (i = this.layers.length - 1; i > index; i--) {
        if ((layer = this.layers[i]) && (!exceptForView || exceptForView !== layer)) {
          (function(layer) {___jdce_logger("/js/libs/lavaca.js", 582);
            this.exitingPageViews.push(layer);
            promise
              .when(layer.exit(this.el, this.enteringPageViews))
              .success(function() {___jdce_logger("/js/libs/lavaca.js", 583);
                delay(function() {___jdce_logger("/js/libs/lavaca.js", 584);
                  ArrayUtils.remove(this.exitingPageViews, layer);
                  if (!layer.cacheKey || (exceptForView && exceptForView.cacheKey === layer.cacheKey)) {
                    layer.dispose();
                  }
     ...
     * @method flush
     */
    flush: function(cacheKey) {___jdce_logger("/js/libs/lavaca.js", 585);
      // Don't dispose of any views that are currently displayed
      //flush individual cacheKey
      if (cacheKey){
        this.pageViews.remove(cacheKey);
     ...
     * @method dispose
     */
    dispose: function() {___jdce_logger("/js/libs/lavaca.js", 586);
      Disposable.prototype.dispose.call(this);
    }
  });
...
define('lavaca/net/Connectivity',['require','$','lavaca/util/Promise','lavaca/util/resolve'],function(require) {___jdce_logger("/js/libs/lavaca.js", 587);
  ...
  function _onAjaxError(arg) {___jdce_logger("/js/libs/lavaca.js", 588);
    if (arg === _offlineErrorCode) {
      var i = -1,
          callback;
      while (!!(callback = _offlineAjaxHandlers[++i])) {
   ...
   *    or if connection status cannot be determined
   */
  Connectivity.isOffline = function() {___jdce_logger("/js/libs/lavaca.js", 589);
    var connectionType = resolve('navigator.connection.type');
    if (connectionType !== null) {
      return connectionType === resolve('Connection.NONE');
    } else {
   ...
   * @return {Lavaca.util.Promise}  A promise
   */
  Connectivity.ajax = function(opts) {___jdce_logger("/js/libs/lavaca.js", 590);
    var promise = new Promise(),
        origSuccess = opts.success,
        origError = opts.error;
    opts.success = function() {___jdce_logger("/js/libs/lavaca.js", 591);
      if (origSuccess) {
        origSuccess.apply(this, arguments);
      }
      promise.resolve.apply(promise, arguments);
    };
    opts.error = function() {___jdce_logger("/js/libs/lavaca.js", 592);
      if (origError) {
        origError.apply(this, arguments);
      }
      promise.reject.apply(promise, arguments);
   ...
   * @param {Function} callback  The callback to execute
   */
  Connectivity.registerOfflineAjaxHandler = function(callback) {___jdce_logger("/js/libs/lavaca.js", 593);
    _offlineAjaxHandlers.push(callback);
  };
...
define('lavaca/net/History',['require','lavaca/events/EventDispatcher','lavaca/util/uuid'],function(require) {___jdce_logger("/js/libs/lavaca.js", 594);
  ...
  function _insertState(hist, position, id, state, title, url) {___jdce_logger("/js/libs/lavaca.js", 595);
    hist.position = position;
    var record = {
          id: id,
          state: state,
   ...
   * @constructor
   */
  var History = EventDispatcher.extend(function() {___jdce_logger("/js/libs/lavaca.js", 596);
    EventDispatcher.call(this);
    /**
     * A list containing history states generated by the app (not used for HTML5 history)
     * @property {Array} sequence
    ...
    if (_standardsMode) {
       ...
       */
       var self = this;
      this.onPopState = function(e) {___jdce_logger("/js/libs/lavaca.js", 597);
        if (e.state) {
          _pushCount--;
          var previousId = _currentId;
          _currentId = e.state.id;
      ...
      this.onPopState = function() {___jdce_logger("/js/libs/lavaca.js", 598);
        var hash = location.hash,
            code,
            record,
            item,
     ...
     * @return {Object}  The current history record
     */
    current: function() {___jdce_logger("/js/libs/lavaca.js", 599);
      return this.sequence[this.position] || null;
    },
    /**
     * Determines whether or not there are history states
     ...
     * @returns {Boolean} True when there is a history state
     */
    hasHistory: function() {___jdce_logger("/js/libs/lavaca.js", 600);
      return _pushCount > 0;
    },
    /**
     * Adds a record to the history
     ...
     * @param {String} url  The URL of the page state
     */
    push: function(state, title, url) {___jdce_logger("/js/libs/lavaca.js", 601);
      _pushCount++;
      if (_hasPushed) {
        document.title = title;
        _currentId = uuid('history');
     ...
     * @param {String} url  The URL of the page state
     */
    replace: function(state, title, url) {___jdce_logger("/js/libs/lavaca.js", 602);
      _hasPushed = true;
      document.title = title;
      if (_standardsMode) {
        history.replaceState({state: state, title: title, url: url, id: _currentId}, title, url);
     ...
     * @method dispose
     */
    dispose: function() {___jdce_logger("/js/libs/lavaca.js", 603);
      if (this.onPopState) {
        if (_standardsMode) {
          window.removeEventListener('popstate', this.onPopState, false);
        } else if (window.detachEvent) {
   ...
   * @return {Lavaca.mvc.History}  The history instance
   */
  History.init = function(useHash) {___jdce_logger("/js/libs/lavaca.js", 604);
    if (!_hist) {
      if (useHash) {
        History.overrideStandardsMode();
      }
   ...
   * @param {String} url  The URL of the page state
   */
  History.push = function() {___jdce_logger("/js/libs/lavaca.js", 605);
    History.init().push.apply(_hist, arguments);
  };
  /**
   * Replaces the current record in the history
   ...
   * @param {String} url  The URL of the page state
   */
  History.replace = function() {___jdce_logger("/js/libs/lavaca.js", 606);
    History.init().replace.apply(_hist, arguments);
  };
  /**
   * Goes to the previous history state
   ...
   * @static
   */
  History.back = function() {___jdce_logger("/js/libs/lavaca.js", 607);
    history.back();
  };
  /**
   * Goes to the next history state
   ...
   * @static
   */
  History.forward = function() {___jdce_logger("/js/libs/lavaca.js", 608);
    history.forward();
  };
  /**
   * Unbind the history object and ready it for garbage collection
   ...
   * @static
   */
  History.dispose = function() {___jdce_logger("/js/libs/lavaca.js", 609);
    if (_hist) {
      _hist.dispose();
      _hist = null;
    }
   ...
   * @return {Lavaca.mvc.History}  The history object (for chaining)
   */
  History.on = function() {___jdce_logger("/js/libs/lavaca.js", 610);
    return History.init().on.apply(_hist, arguments);
  };
  /**
   * Unbinds an event handler from the singleton history
   ...
   * @return {Lavaca.mvc.History}  The history object (for chaining)
   */
  History.off = function() {___jdce_logger("/js/libs/lavaca.js", 611);
    return History.init().off.apply(_hist, arguments);
  };
  /**
   * Sets Histroy to hash mode
   ...
   * @static
   */
  History.overrideStandardsMode = function() {___jdce_logger("/js/libs/lavaca.js", 612);
    _standardsMode = false;
  };
...
define('lavaca/storage/Store',['require','lavaca/util/Disposable'],function(require) {___jdce_logger("/js/libs/lavaca.js", 613);

  var Disposable = require('lavaca/util/Disposable');

  function _notImplemented() {___jdce_logger("/js/libs/lavaca.js", 614);
   ...
   * @extends lavaca.util.Disposable
   */
  var Store = Disposable.extend(function(id) {___jdce_logger("/js/libs/lavaca.js", 615);
    /**
     * The ID of the store
     * @property {String} id
     */
     ...
     */
    get: function() {___jdce_logger("/js/libs/lavaca.js", 616);
      _notImplemented();
    },
    /**
     ...
     */
    set: function() {___jdce_logger("/js/libs/lavaca.js", 617);
      _notImplemented();
    },
    /**
     ...
     */
    remove: function() {___jdce_logger("/js/libs/lavaca.js", 618);
      _notImplemented();
    },
    /**
     ...
     */
    all: function() {___jdce_logger("/js/libs/lavaca.js", 619);
      _notImplemented();
    }
  });
...
|*|
\*/
define('docCookies',[],function() {___jdce_logger("/js/libs/lavaca.js", 620);
  var escape = window.escape;
  var unescape = window.unescape;
  var docCookies = {
    getItem: function (sKey) {___jdce_logger("/js/libs/lavaca.js", 621);
      return unescape(document.cookie.replace(new RegExp("(?:(?:^|.*;\\s*)" + escape(sKey).replace(/[\-\.\+\*]/g, "\\$&") + "\\s*\\=\\s*((?:[^;](?!;))*[^;]?).*)|.*"), "$1")) || null;
    },
    setItem: function (sKey, sValue, vEnd, sPath, sDomain, bSecure) {___jdce_logger("/js/libs/lavaca.js", 622);
    ...
    removeItem: function (sKey, sPath) {___jdce_logger("/js/libs/lavaca.js", 623);
      if (!sKey || !this.hasItem(sKey)) { return false; }
      document.cookie = escape(sKey) + "=; expires=Thu, 01 Jan 1970 00:00:00 GMT" + (sPath ? "; path=" + sPath : "");
      return true;
    },
    hasItem: function (sKey) {___jdce_logger("/js/libs/lavaca.js", 624);
      return (new RegExp("(?:^|;\\s*)" + escape(sKey).replace(/[\-\.\+\*]/g, "\\$&") + "\\s*\\=")).test(document.cookie);
    },
    keys: /* optional method: you can safely remove it! */ function () {___jdce_logger("/js/libs/lavaca.js", 625);
...
define('lavaca/storage/LocalStore',['require','./Store','docCookies','lavaca/util/ArrayUtils'],function(require) {___jdce_logger("/js/libs/lavaca.js", 626);

  var Store = require('./Store'),
      docCookies = require('docCookies'),
      ArrayUtils = require('lavaca/util/ArrayUtils');

  var _isLocalStorageSupported = (function(localStorage) {___jdce_logger("/js/libs/lavaca.js", 627);
    var testKey = 'qeTest';
    if (!localStorage) {
      return false;
    }
  ...
  function _saveManifest(store) {___jdce_logger("/js/libs/lavaca.js", 628);
   ...
   */
  var LocalStore = Store.extend(function(id) {___jdce_logger("/js/libs/lavaca.js", 629);
    Store.call(this, id);
     /**
     ...
     */
    key: function(id) {___jdce_logger("/js/libs/lavaca.js", 630);
      return this.id + ':' + id;
    },
    /**
     * Retrieves an object from storage, given its ID
     ...
     * @return {Object}  The stored object
     */
    get: function(id) {___jdce_logger("/js/libs/lavaca.js", 631);
     ...
     * @param {Object} value  The value to store
     */
    set: function(id, value) {___jdce_logger("/js/libs/lavaca.js", 632);
     ...
     * @param {String} id  The ID of the object to remove from storage
     */
    remove: function(id) {___jdce_logger("/js/libs/lavaca.js", 633);
     ...
     * @return {Array}  A list of stored objects
     */
    all: function() {___jdce_logger("/js/libs/lavaca.js", 634);
      var result = [],
          i = -1,
          id;
...
define('lavaca/ui/DustTemplate',['require','dust','lavaca/ui/Template','lavaca/util/Config','lavaca/util/Promise','lavaca/util/StringUtils','lavaca/util/Translation','dust-helpers'],function(require) {___jdce_logger("/js/libs/lavaca.js", 635);
   ...
   */
  var DustTemplate = Template.extend(function() {___jdce_logger("/js/libs/lavaca.js", 636);
     ...
     */
    prepareHelpers: function() {___jdce_logger("/js/libs/lavaca.js", 637);
      return {
        msg: this.helperMsg,
     ...
     */
    helperMsg: function(chunk, context, bodies, params) {___jdce_logger("/js/libs/lavaca.js", 638);
     ...
     * @return {String}  Rendered output
     */
    helperInclude: function(chunk, context, bodies, params) {___jdce_logger("/js/libs/lavaca.js", 639);
      ...
      Template
        ...
        .then(function(html) {___jdce_logger("/js/libs/lavaca.js", 640);
          result = html;
        });
     ...
     * @return {String}  Rendered output
     */
    helperConfig: function(chunk, context, bodies, params) {___jdce_logger("/js/libs/lavaca.js", 641);
      var key = dust.helpers.tap(params.key, chunk, context),
     ...
     * @method compile
     */
    compile: function() {___jdce_logger("/js/libs/lavaca.js", 642);
     ...
     * @return {Lavaca.util.Promise}  A promise
     */
    render: function(model) {___jdce_logger("/js/libs/lavaca.js", 643);
      var promise = new Promise(this);
      ...
      dust.render(this.name, model, function(err, html) {___jdce_logger("/js/libs/lavaca.js", 644);
        if (err) {
          promise.reject(err);
        } else {
     ...
     * @method dispose
     */
    dispose: function() {___jdce_logger("/js/libs/lavaca.js", 645);
      delete dust.cache[this.name];
      Template.prototype.dispose.call(this);
    }
  });

  DustTemplate.getCompiledTemplates = function() {___jdce_logger("/js/libs/lavaca.js", 646);
    return dust.cache;
  };
...
define('lavaca/ui/Widget',['require','$','lavaca/events/EventDispatcher','lavaca/util/uuid'],function(require) {___jdce_logger("/js/libs/lavaca.js", 647);
   ...
   */
  var Widget = EventDispatcher.extend(function(el) {___jdce_logger("/js/libs/lavaca.js", 648);
    EventDispatcher.call(this);
    /**
...
define('lavaca/ui/Form',['require','$','lavaca/ui/Widget','lavaca/util/Promise'],function(require) {___jdce_logger("/js/libs/lavaca.js", 649);

  var $ = require('$'),
      Widget = require('lavaca/ui/Widget'),
      Promise = require('lavaca/util/Promise');

  function _required(value) {___jdce_logger("/js/libs/lavaca.js", 650);
    return value ? null : 'error_required';
  }

  function _pattern(value, input) {___jdce_logger("/js/libs/lavaca.js", 651);
    if (value) {
  ...
  function _email(value) {___jdce_logger("/js/libs/lavaca.js", 652);
  ...
  function _tel(value) {___jdce_logger("/js/libs/lavaca.js", 653);
  ...
  function _number(value) {___jdce_logger("/js/libs/lavaca.js", 654);
  ...
  function _url(value) {___jdce_logger("/js/libs/lavaca.js", 655);
   ...
   * @param {jQuery} el  The DOM element that is the root of the widget
   */
  var Form = Widget.extend(function() {___jdce_logger("/js/libs/lavaca.js", 656);
    Widget.apply(this, arguments);
    var self = this;
    this.pendingSync = {};
    this._onChangeInput = function(e) {___jdce_logger("/js/libs/lavaca.js", 657);
      self.onChangeInput(e);
    };
    this._onSubmit = function(e) {___jdce_logger("/js/libs/lavaca.js", 658);
      self.onSubmit(e);
    };
     ...
     */
    onSubmit: function(e) {___jdce_logger("/js/libs/lavaca.js", 659);
      e.preventDefault();
      this.validate()
     ...
     */
    onSubmitSuccess: function() {___jdce_logger("/js/libs/lavaca.js", 660);
      // Placeholder
    },
    /**
     ...
     */
    onSubmitError: function() {___jdce_logger("/js/libs/lavaca.js", 661);
      // Placeholder
    },
    /**
     ...
     */
    onChangeInput: function(e) {___jdce_logger("/js/libs/lavaca.js", 662);
      if (this.model) {
        var input = $(e.target),
     ...
     * @param {Event} e  The change event
     */
    onChangeModel: function(e) {___jdce_logger("/js/libs/lavaca.js", 663);
     ...
     */
    bind: function(model) {___jdce_logger("/js/libs/lavaca.js", 664);
      this.unbind();
      this.model = model;
     ...
     * @method unbind
     */
    unbind: function() {___jdce_logger("/js/libs/lavaca.js", 665);
      if (this.model) {
     ...
     */
    input: function(name) {___jdce_logger("/js/libs/lavaca.js", 666);
     ...
     */
    get: function(name) {___jdce_logger("/js/libs/lavaca.js", 667);
     ...
     */
    set: function(name, value) {___jdce_logger("/js/libs/lavaca.js", 668);
     ...
     */
    defaultRules: function() {___jdce_logger("/js/libs/lavaca.js", 669);
      return {
        '[required]': _required,
        '[pattern]': _pattern,
        '[type=email]': _email,
     ...
     */
    addRule: function(selector, callback) {___jdce_logger("/js/libs/lavaca.js", 670);
      if (!this.rules) {
        this.rules = [];
      }
      if (typeof selector === 'object') {
     ...
     */
    values: function() {___jdce_logger("/js/libs/lavaca.js", 671);
     ...
     * @return {Lavaca.util.Promise}  A promise
     */
    validate: function(success, error, input) {___jdce_logger("/js/libs/lavaca.js", 672);
      ...
      return promise
        .error(function(inputs) {___jdce_logger("/js/libs/lavaca.js", 673);
          this.trigger('invalid', {inputs: inputs});
        })
        .success(function(values) {___jdce_logger("/js/libs/lavaca.js", 674);
     ...
     * @method dispose
     */
    dispose: function() {___jdce_logger("/js/libs/lavaca.js", 675);
      this.unbind();
   ...
   */
  Form.withSubmit = function(success, error) {___jdce_logger("/js/libs/lavaca.js", 676);
    return Form.extend({
      onSubmitSuccess: function(values) {___jdce_logger("/js/libs/lavaca.js", 677);
        success.call(this, values);
      },
      onSubmitError: function(inputs) {___jdce_logger("/js/libs/lavaca.js", 678);
...
define('lavaca/ui/Widget',['require','$','lavaca/events/EventDispatcher','lavaca/util/uuid'],function(require) {___jdce_logger("/js/libs/lavaca.js", 679);
   ...
   * @param {jQuery} el  The DOM element that is the root of the widget
   */
  var Widget = EventDispatcher.extend(function(el) {___jdce_logger("/js/libs/lavaca.js", 680);
    EventDispatcher.call(this);
    /**
     * The DOM element that is the root of the widget
     * @property {jQuery} el
...
define('lavaca/ui/LoadingIndicator',['require','$','./Widget'],function(require) {___jdce_logger("/js/libs/lavaca.js", 681);
  ...
  var LoadingIndicator = Widget.extend({
     ...
     * @method show
     */
    show: function() {___jdce_logger("/js/libs/lavaca.js", 682);
     ...
     * @method hide
     */
    hide: function() {___jdce_logger("/js/libs/lavaca.js", 683);
   ...
   */
  LoadingIndicator.init = function(TLoadingIndicator) {___jdce_logger("/js/libs/lavaca.js", 684);
    TLoadingIndicator = TLoadingIndicator || LoadingIndicator;
    var indicator = new TLoadingIndicator(document.body);
    function show() {___jdce_logger("/js/libs/lavaca.js", 685);
      indicator.show();
    }
    function hide() {___jdce_logger("/js/libs/lavaca.js", 686);
      indicator.hide();
    }
    $(document)
      .on('ajaxStart', show)
...
define('lavaca/ui/Template',['require','lavaca/util/Cache','lavaca/util/Map'],function(require) {___jdce_logger("/js/libs/lavaca.js", 687);
  ...
  var Template = Map.extend({
     ...
     * @method compile
     */
    compile: function() {___jdce_logger("/js/libs/lavaca.js", 688);
      // Do nothing
    },
    /**
     * Renders the template to a string
     ...
     * @return {Lavaca.util.Promise}  A promise
     */
    render: function() {___jdce_logger("/js/libs/lavaca.js", 689);
      throw 'Abstract';
    },
    /**
     * Parses server data to include in this lookup
     ...
     * @param {String} text  The server data string
     */
    process: function(text) {___jdce_logger("/js/libs/lavaca.js", 690);
      this.code = text;
    }
  });
  /**
   ...
   * @return {Lavaca.ui.Template}  The template (or null if no such template exists)
   */
  Template.get = function(name) {___jdce_logger("/js/libs/lavaca.js", 691);
    return _cache.get(name);
  };
  /**
   * Scans the document for all templates with registered types and
   ...
   * @param {jQuery} scope  The element to which to limit the scan
   */
  Template.init = function(scope) {___jdce_logger("/js/libs/lavaca.js", 692);
    var i = -1,
        type, templates, templateName, template;

    while (!!(type = _types[++i])) {
      var construct = function(name, src, code) {___jdce_logger("/js/libs/lavaca.js", 693);
        return new type.js(name, src, code);
      };
   ...
   * @static
   */
  Template.dispose = function() {___jdce_logger("/js/libs/lavaca.js", 694);
    Map.dispose(_cache);
  };
  /**
   * Finds the named template and renders it to a string
   ...
   * @return {Lavaca.util.Promise}  A promise
   */
  Template.render = function(name, model) {___jdce_logger("/js/libs/lavaca.js", 695);
    var template = Template.get(name);
    if (!template) {
      throw 'No template named "' + name + '"';
    } else {
   ...
   * @param {Function} TTemplate  The JavaScript type used for the template (should derive from [[Lavaca.ui.Template]])
   */
  Template.register = function(mimeType, TTemplate) {___jdce_logger("/js/libs/lavaca.js", 696);
    if (typeof mimeType === "function") {
      TTemplate = mimeType;
      mimeType = null;
    }
...
define('lavaca/util/ArrayUtils',[],function() {___jdce_logger("/js/libs/lavaca.js", 697);
   ...
   * @return {Number}  The first index of the object, or -1 if not found
   */
  ArrayUtils.indexOf = function(a, o) {___jdce_logger("/js/libs/lavaca.js", 698);
    if (!a) {
      return -1;
    } else if (a.indexOf) {
      return a.indexOf(o);
   ...
   * @return {Boolean}  True when the array contains the object, false otherwise
   */
  ArrayUtils.contains = function(a, o) {___jdce_logger("/js/libs/lavaca.js", 699);
    return ArrayUtils.indexOf(a, o) > -1;
  };
   ...
   *   in the array)
   */
  ArrayUtils.remove = function(a, o) {___jdce_logger("/js/libs/lavaca.js", 700);
    var index = ArrayUtils.indexOf(a, o);
    if (index > -1) {
      a.splice(index, 1);
    }
   ...
   * @return {Number}  The index of the item in the array
   */
  ArrayUtils.pushIfNotExists = function(a, o) {___jdce_logger("/js/libs/lavaca.js", 701);
    var index = ArrayUtils.indexOf(a, o);
    if (index === -1) {
      a[index = a.length] = o;
    }
   ...
   * @return {Boolean}  True if a is a true array
   */
  ArrayUtils.isArray = function(a) {___jdce_logger("/js/libs/lavaca.js", 702);
    return Array.isArray === 'function' ? Array.isArray(a) : Object.prototype.toString.call(a) === '[object Array]';
  };
...
define('lavaca/util/Cache',['require','lavaca/util/Disposable','lavaca/util/uuid'],function(require) {___jdce_logger("/js/libs/lavaca.js", 703);
  ...
  var Cache = Disposable.extend({
     ...
     * @return {Object}  The stored item (or null if no item is stored and no default)
     */
    get: function(id, def) {___jdce_logger("/js/libs/lavaca.js", 704);
      var result = this['@' + id];
      if (result === undefined && def !== undefined) {
        result = this['@' + id] = def;
      }
     ...
     * @param {Object} value  The object to store in the cache
     */
    set: function(id, value) {___jdce_logger("/js/libs/lavaca.js", 705);
      this['@' + id] = value;
    },
    /**
     * Adds an item to the cache
     ...
     * @return {String}  The auto-generated ID under which the value was stored
     */
    add: function(value) {___jdce_logger("/js/libs/lavaca.js", 706);
      var id = uuid();
      this.set(id, value);
      return id;
    },
     ...
     * @param {String} id  The key under which the item is stored
     */
    remove: function(id) {___jdce_logger("/js/libs/lavaca.js", 707);
      delete this['@' + id];
    },
    /**
     * Executes a callback for each cached item. To stop iteration immediately,
     ...
     * @param {Object} thisp  The context of the callback
     */
    each: function(cb, thisp) {___jdce_logger("/js/libs/lavaca.js", 708);
      var prop, returned;
      for (prop in this) {
        if (this.hasOwnProperty(prop) && prop.indexOf('@') === 0) {
          returned = cb.call(thisp || this, prop.slice(1), this[prop]);
     ...
     * @return {Object}  The resulting key-value hash
     */
    toObject: function() {___jdce_logger("/js/libs/lavaca.js", 709);
      var result = {};
      this.each(function(prop, value) {___jdce_logger("/js/libs/lavaca.js", 710);
        result[prop] = (value && typeof value.toObject === 'function') ? value.toObject() : value;
      });
      return result;
    },
     ...
     * @return {String}  The JSON string
     */
    toJSON: function() {___jdce_logger("/js/libs/lavaca.js", 711);
      return JSON.stringify(this.toObject());
    },
     /**
     * Serializes the cache to an array
     ...
     * @return {Object}  The resulting array with elements being index based and keys stored in an array on the 'ids' property
     */
    toArray: function() {___jdce_logger("/js/libs/lavaca.js", 712);
      var results = [];
      results['ids'] = [];
      this.each(function(prop, value) {___jdce_logger("/js/libs/lavaca.js", 713);
        results.push(typeof value.toObject === 'function' ? value.toObject() : value);
        results['ids'].push(prop);
      });
      return results;
     ...
     * @method clear
     */
    clear: function() {___jdce_logger("/js/libs/lavaca.js", 714);
       this.each(function(key, item) {___jdce_logger("/js/libs/lavaca.js", 715);
         this.remove(key);
       }, this);
    },
     ...
     * @method count
     */
    count: function() {___jdce_logger("/js/libs/lavaca.js", 716);
      var count = 0;
      this.each(function(key, item) {___jdce_logger("/js/libs/lavaca.js", 717);
        count++;
      }, this);
      return count;
    },
     ...
     * @method dispose
     */
    dispose: function() {___jdce_logger("/js/libs/lavaca.js", 718);
      this.clear();
      Disposable.prototype.dispose.apply(this, arguments);
    }
  });
...
define('lavaca/util/extend',[],function() {___jdce_logger("/js/libs/lavaca.js", 719);
  /**
   * Establishes inheritance between types. After a type is extended, it receives its own static
   * convenience method, extend(TSub, overrides).
   * @class lavaca.util.extend
   ...
   * @return {Function}  The subtype
   */
  var extend = function(TSuper, TSub, overrides) {___jdce_logger("/js/libs/lavaca.js", 720);
    if (typeof TSuper === 'object') {
      overrides = TSuper;
      TSuper = Object;
      TSub = function() {___jdce_logger("/js/libs/lavaca.js", 721);
        // Empty
      };
    } else if (typeof TSub === 'object') {
      overrides = TSub;
    ...
    function ctor() {___jdce_logger("/js/libs/lavaca.js", 722);
      // Empty
    }
    ctor.prototype = TSuper.prototype;
    TSub.prototype = new ctor;
    ...
    TSub.extend = function(T, overrides) {___jdce_logger("/js/libs/lavaca.js", 723);
      if (typeof T === 'object') {
        overrides = T;
        T = function() {___jdce_logger("/js/libs/lavaca.js", 724);
          TSub.apply(this, arguments);
        };
      }
      extend(TSub, T, overrides);
...
define('lavaca/util/Disposable',['require','./extend'],function(require) {___jdce_logger("/js/libs/lavaca.js", 725);

  var extend = require('./extend');

  function _disposeOf(obj) {___jdce_logger("/js/libs/lavaca.js", 726);
    var n,
        o,
        i;
    for (n in obj) {
  ...
  var Disposable = extend({
     ...
     *
     */
    dispose: function() {___jdce_logger("/js/libs/lavaca.js", 727);
        _disposeOf(this);
    }
  });
...
define('lavaca/util/Map',['require','$','./Cache','./Disposable','lavaca/net/Connectivity'],function(require) {___jdce_logger("/js/libs/lavaca.js", 728);
  ...
  function _absolute(url) {___jdce_logger("/js/libs/lavaca.js", 729);
    if (url && url.indexOf('http') !== 0) {
      if (url.charAt(0) === '/') {
        url = location.protocol + '//'
          + location.hostname
   ...
   * @param {String} code  The raw string data for the map (or null if src is supplied)
   */
  var Map = Disposable.extend(function(name, src, code) {___jdce_logger("/js/libs/lavaca.js", 730);
    Disposable.call(this);
    /**
     * Whether or not the map has loaded
     * @property {Boolean} hasLoaded
     ...
     * @return {Boolean}  True if this is the lookup
     */
    is: function(name) {___jdce_logger("/js/libs/lavaca.js", 731);
      return this.name === name;
    },
    /**
     * Gets the value stored under a code
     ...
     * @return {Object}  The value (or null)
     */
    get: function(code) {___jdce_logger("/js/libs/lavaca.js", 732);
      if (!this.hasLoaded) {
        if (this.code) {
          this.add(this.code);
        } else if (this.src) {
     ...
     * @param {Object} data  The parameters to add
     */
    add: function(data) {___jdce_logger("/js/libs/lavaca.js", 733);
      for (var n in data) {
        this.cache.set(n, data[n]);
      }
    },
     ...
     * @param {String} text  The server data string
     */
    process: function(text) {___jdce_logger("/js/libs/lavaca.js", 734);
      this.add(typeof text === 'string' ? JSON.parse(text) : text);
    },
    /**
     * Adds JSON data to this map (synchronous)
     ...
     * @param {String} url  The URL of the data
     */
    load: function(url) {___jdce_logger("/js/libs/lavaca.js", 735);
      var self = this;
      Connectivity.ajax({
        async: false,
        url: url,
        success: function(resp) {___jdce_logger("/js/libs/lavaca.js", 736);
          self.process(resp);
        }
      });
    }
   ...
   * @param {String} name  The name of the config
   */
  Map.setDefault = function(cache, name) {___jdce_logger("/js/libs/lavaca.js", 737);
    var map = name;
    if (typeof map === 'string') {
      map = cache.get(name);
    }
   ...
   * @return {Object}  The value of the parameter
   */
  Map.get = function(cache, name, code, defaultName) {___jdce_logger("/js/libs/lavaca.js", 738);
    if (!code) {
      code = name;
      name = defaultName;
    }
   ...
   * @param {jQuery} scope  The element to which to limit the scan
   */
  Map.init = function(cache, mimeType, construct, scope) {___jdce_logger("/js/libs/lavaca.js", 739);
    $(scope || document.documentElement)
      .find('script[type="' + mimeType + '"]')
      .each(function() {___jdce_logger("/js/libs/lavaca.js", 740);
        var item = $(this),
            src = item.attr('data-src'),
            name = item.attr('data-name'),
            isDefault = typeof item.attr('data-default') === 'string',
   ...
   * @param {Lavaca.util.Cache} cache  The map cache
   */
  Map.dispose = function(cache) {___jdce_logger("/js/libs/lavaca.js", 741);
    cache.dispose();
  };
...
define('lavaca/util/Config',['require','./Cache','./Map'],function(require) {___jdce_logger("/js/libs/lavaca.js", 742);
  ...
  function _construct(name, src, code) {___jdce_logger("/js/libs/lavaca.js", 743);
    if (code) {
      code = JSON.parse(code);
    }
    return new Config(name, src, code);
   ...
   * @param {String} name  The name of the default config
   */
  Config.setDefault = function(name) {___jdce_logger("/js/libs/lavaca.js", 744);
    Map.setDefault(_cache, name);
  };
  /**
   * Gets the application's current config environment name
   ...
   * @return {String} The name of the current environment
   */
  Config.currentEnvironment = function() {___jdce_logger("/js/libs/lavaca.js", 745);
    return _cache.get('default').name;
  };
  /**
   * Retrieves a value from the configuration
   ...
   * @return {Object}  The value of the parameter
   */
  Config.get = function(name, code) {___jdce_logger("/js/libs/lavaca.js", 746);
    return Map.get(_cache, name, code, 'default');
  };
  /**
   * Scans the document for all translations and prepares them
   ...
   * @param {jQuery} scope  The element to which to limit the scan
   */
  Config.init = function(scope) {___jdce_logger("/js/libs/lavaca.js", 747);
    Map.init(_cache, 'text/x-config', _construct, scope);
  };
  /**
   * Disposes of all translations
   ...
   * @static
   */
  Config.dispose = function() {___jdce_logger("/js/libs/lavaca.js", 748);
    Map.dispose(_cache);
  };
...
define('lavaca/util/Translation',['require','./Cache','./Map'],function(require) {___jdce_logger("/js/libs/lavaca.js", 749);
  ...
  function _construct(name, src, code) {___jdce_logger("/js/libs/lavaca.js", 750);
    if (code) {
      code = JSON.parse(code);
    }
    var map = new Translation(name, src, code);
   ...
   * @param {String} code  The raw string data for the map (or null if src is supplied)
   */
  var Translation = Map.extend(function(name) {___jdce_logger("/js/libs/lavaca.js", 751);
    Map.apply(this, arguments);
    var locale = name.toLowerCase().split('_');
    /**
     * The ISO 639-2 code for the translation's language
     ...
     * @return {Boolean}  True if this translation applies
     */
    is: function(language, country) {___jdce_logger("/js/libs/lavaca.js", 752);
      return language === this.language
        && (!country || !this.country || country === this.country);
    }
  });
   ...
   * @param {String} locale  A locale string (ie, "en", "en_US", or "es_MX")
   */
  Translation.setDefault = function(locale) {___jdce_logger("/js/libs/lavaca.js", 753);
    _cache.remove('default');
    Map.setDefault(_cache, Translation.forLocale(locale));
  };
  /**
   ...
   * @return {Lavaca.util.Translation}  The translation
   */
  Translation.forLocale = function(locale) {___jdce_logger("/js/libs/lavaca.js", 754);
    locale = (locale || 'default').toLowerCase();
    return _cache.get(locale)
      || _cache.get(locale.split('_')[0])
      || _cache.get('default');
   ...
   * @return {Lavaca.util.Translation}  The translation
   */
  Translation.get = function(locale, code) {___jdce_logger("/js/libs/lavaca.js", 755);
    if (!code) {
      code = locale;
      locale = 'default';
    }
   ...
   * @param {jQuery} scope  The element to which to limit the scan
   */
  Translation.init = function(locale, scope) {___jdce_logger("/js/libs/lavaca.js", 756);
    Map.init(_cache, 'text/x-translation', _construct, scope);
    Translation.setDefault(locale);
  };
  /**
   ...
   * @static
   */
  Translation.dispose = function() {___jdce_logger("/js/libs/lavaca.js", 757);
    Map.dispose(_cache);
  };
...
define('lavaca/util/DateUtils',['require','./Translation'],function(require) {___jdce_logger("/js/libs/lavaca.js", 758);
  ...
  function _int(input) {___jdce_logger("/js/libs/lavaca.js", 759);
    return parseInt(input, 10);
  }

  function _indexOfCode(input, array) {___jdce_logger("/js/libs/lavaca.js", 760);
  ...
  function _pad(n, digits, c) {___jdce_logger("/js/libs/lavaca.js", 761);
    var sign = n < 0 ? '-' : '';
    c = c || '0';
  ...
  function _translate(s) {___jdce_logger("/js/libs/lavaca.js", 762);
  ...
  DateUtils.fn = {
    d: {
      exp: '\\d{1,2}',
      i: function(input, dateObj) {___jdce_logger("/js/libs/lavaca.js", 763);
        dateObj.date = _int(input);
      },
      o: function(date, utc) {___jdce_logger("/js/libs/lavaca.js", 764);
        return (utc ? date.getUTCDate() : date.getDate()).toString();
      }
    },
    dd: {
      exp: '\\d{2}',
      i: function(input, dateObj) {___jdce_logger("/js/libs/lavaca.js", 765);
        dateObj.date = _int(input);
      },
      o: function(date, utc) {___jdce_logger("/js/libs/lavaca.js", 766);
        return _pad(DateUtils.fn.d.o(date, utc), 2);
      }
    },
    ddd: {
      exp: '[a-z]{3}',
      i: function() {___jdce_logger("/js/libs/lavaca.js", 767);
        // Do nothing
      },
      o: function(date, utc) {___jdce_logger("/js/libs/lavaca.js", 768);
        return _translate(DateUtils.daysOfWeekAbbr[utc ? date.getUTCDay() : date.getDay()]);
      }
    },
    dddd: {
      exp: '[a-z]+',
      i: function() {___jdce_logger("/js/libs/lavaca.js", 769);
        // Do nothing
      },
      o: function(date, utc) {___jdce_logger("/js/libs/lavaca.js", 770);
        return _translate(DateUtils.daysOfWeek[utc ? date.getUTCDay() : date.getDay()]);
      }
    },
    f: {
      exp: '\\d',
      i: function(input, dateObj) {___jdce_logger("/js/libs/lavaca.js", 771);
        dateObj.ms = _int(input) * 100;
      },
      o: function(date, utc, divisor) {___jdce_logger("/js/libs/lavaca.js", 772);
        divisor = divisor || 100;
    ...
    ff: {
      exp: '\\d{2}',
      i: function(input, dateObj) {___jdce_logger("/js/libs/lavaca.js", 773);
        dateObj.ms = _int(input) * 10;
      },
      o: function(date, utc) {___jdce_logger("/js/libs/lavaca.js", 774);
        return _pad(DateUtils.fn.f.o(date, utc, 10), 2);
      }
    },
    fff: {
      exp: '\\d{3}',
      i: function(input, dateObj) {___jdce_logger("/js/libs/lavaca.js", 775);
        dateObj.ms = _int(input, 10);
      },
      o: function(date, utc) {___jdce_logger("/js/libs/lavaca.js", 776);
        return _pad(DateUtils.fn.f.o(date, utc, 1), 3);
      }
    },
    h: {
      exp: '1?\\d',
      i: function(input, dateObj, mappedObj) {___jdce_logger("/js/libs/lavaca.js", 777);
        var h = _int(input) - 1,
            tod = (mappedObj.t || mappedObj.tt || 'A').indexOf('A') === 0 ? 0 : 12;
        dateObj.hour = h + tod;
      },
      o: function(date, utc) {___jdce_logger("/js/libs/lavaca.js", 778);
        return ((utc ? date.getUTCHours() : date.getHours()) % 12 + 1).toString();
      }
    },
    hh: {
      exp: '[0-1]\\d',
      i: function(input, dateObj, mappedObj) {___jdce_logger("/js/libs/lavaca.js", 779);
        DateUtils.fn.h.i(input, dateObj, mappedObj);
      },
      o: function(date, utc) {___jdce_logger("/js/libs/lavaca.js", 780);
        return _pad(DateUtils.fn.h.o(date, utc), 2);
      }
    },
    H: {
      exp: '[0-2]?\\d',
      i: function(input, dateObj) {___jdce_logger("/js/libs/lavaca.js", 781);
        dateObj.hour = _int(input);
      },
      o: function(date, utc) {___jdce_logger("/js/libs/lavaca.js", 782);
        return (utc ? date.getUTCHours() : date.getHours()).toString();
      }
    },
    HH: {
      exp: '[0-2]\\d',
      i: function(input, dateObj) {___jdce_logger("/js/libs/lavaca.js", 783);
        dateObj.hour = _int(input);
      },
      o: function (date, utc) {___jdce_logger("/js/libs/lavaca.js", 784);
        return _pad(DateUtils.fn.H.o(date, utc), 2);
      }
    },
    m: {
      exp: '[1-5]?\\d',
      i: function(input, dateObj) {___jdce_logger("/js/libs/lavaca.js", 785);
        dateObj.minute = _int(input);
      },
      o: function(date, utc) {___jdce_logger("/js/libs/lavaca.js", 786);
        return (utc ? date.getUTCMinutes() : date.getMinutes()).toString();
      }
    },
    mm: {
      exp: '[0-5]\\d',
      i: function(input, dateObj, mappedObj) {___jdce_logger("/js/libs/lavaca.js", 787);
        DateUtils.fn.m.i(input, dateObj, mappedObj);
      },
      o: function(date, utc) {___jdce_logger("/js/libs/lavaca.js", 788);
        return _pad(DateUtils.fn.m.o(date, utc), 2);
      }
    },
    M: {
      exp: '1?\\d',
      i: function(input, dateObj) {___jdce_logger("/js/libs/lavaca.js", 789);
        dateObj.month = _int(input) - 1;
      },
      o: function(date, utc) {___jdce_logger("/js/libs/lavaca.js", 790);
        return ((utc ? date.getUTCMonth() : date.getMonth()) + 1).toString();
      }
    },
    MM: {
      exp: '[0-1]\\d',
      i: function(input, dateObj, mappedObj) {___jdce_logger("/js/libs/lavaca.js", 791);
        DateUtils.fn.M.i(input, dateObj, mappedObj);
      },
      o: function(date, utc) {___jdce_logger("/js/libs/lavaca.js", 792);
        return _pad(DateUtils.fn.M.o(date, utc), 2);
      }
    },
    MMM: {
      exp: '[a-z]{3}',
      i: function(input, dateObj) {___jdce_logger("/js/libs/lavaca.js", 793);
        dateObj.month = _indexOfCode(input, DateUtils.monthsAbbr);
      },
      o: function(date, utc) {___jdce_logger("/js/libs/lavaca.js", 794);
        return _translate(DateUtils.monthsAbbr[utc ? date.getUTCMonth() : date.getMonth()]);
      }
    },
    MMMM: {
      exp: '[a-z]+',
      i: function(input, dateObj) {___jdce_logger("/js/libs/lavaca.js", 795);
        dateObj.month = _indexOfCode(input, DateUtils.months);
      },
      o: function(date, utc) {___jdce_logger("/js/libs/lavaca.js", 796);
        return _translate(DateUtils.months[utc ? date.getUTCMonth() : date.getMonth()]);
      }
    },
    s: {
      exp: '[1-5]?\\d',
      i: function(input, dateObj) {___jdce_logger("/js/libs/lavaca.js", 797);
        dateObj.second = _int(input);
      },
      o: function(date, utc) {___jdce_logger("/js/libs/lavaca.js", 798);
        return (utc ? date.getUTCSeconds() : date.getSeconds()).toString();
      }
    },
    ss: {
      exp: '[0-5]\\d',
      i: function(input, dateObj, mappedObj) {___jdce_logger("/js/libs/lavaca.js", 799);
        DateUtils.fn.s.i(input, dateObj, mappedObj);
      },
      o: function(date, utc) {___jdce_logger("/js/libs/lavaca.js", 800);
        return _pad(DateUtils.fn.s.o(date, utc), 2);
      }
    },
    t: {
      exp: '[a-z]',
      i: function() {___jdce_logger("/js/libs/lavaca.js", 801);
        // Do nothing
      },
      o: function(date, utc) {___jdce_logger("/js/libs/lavaca.js", 802);
        return _translate(DateUtils.timeOfDayDesignatorAbbr[Math.floor((utc ? date.getUTCHours() : date.getHours()) / 12)]);
      }
    },
    tt: {
      exp: '[a-z]+',
      i: function() {___jdce_logger("/js/libs/lavaca.js", 803);
        // Do nothing
      },
      o: function(date, utc) {___jdce_logger("/js/libs/lavaca.js", 804);
        return _translate(DateUtils.timeOfDayDesignator[Math.floor((utc ? date.getUTCHours() : date.getHours()) / 12)]);
      }
    },
    y: {
      exp: '\\d?\\d',
      i: function(input, dateObj) {___jdce_logger("/js/libs/lavaca.js", 805);
        dateObj.year = (new Date()).getFullYear() % 100 + _int(input);
      },
      o: function(date, utc) {___jdce_logger("/js/libs/lavaca.js", 806);
        return ((utc ? date.getUTCFullYear() : date.getFullYear()) % 100).toString();
      }
    },
    yy: {
      exp: '\\d{2}',
      i: function(input, dateObj, mappedObj) {___jdce_logger("/js/libs/lavaca.js", 807);
        DateUtils.fn.y.i(input, dateObj, mappedObj);
      },
      o: function(date, utc) {___jdce_logger("/js/libs/lavaca.js", 808);
        return _pad(DateUtils.fn.y.o(date, utc), 2);
      }
    },
    yyy: {
      exp: '\\d*\\d{3}',
      i: function(input, dateObj) {___jdce_logger("/js/libs/lavaca.js", 809);
        dateObj.year = _int(input);
      },
      o: function(date, utc) {___jdce_logger("/js/libs/lavaca.js", 810);
        return _pad(utc ? date.getUTCFullYear() : date.getFullYear(), 3);
      }
    },
    yyyy: {
      exp: '\\d*\\d{4}',
      i: function(input, dateObj, mappedObj) {___jdce_logger("/js/libs/lavaca.js", 811);
        DateUtils.fn.yyy.i(input, dateObj, mappedObj);
      },
      o: function(date, utc) {___jdce_logger("/js/libs/lavaca.js", 812);
        return _pad(utc ? date.getUTCFullYear() : date.getFullYear(), 4);
      }
    },
    z: {
      exp: '[-+]?1?\\d',
      i: function(input, dateObj) {___jdce_logger("/js/libs/lavaca.js", 813);
        dateObj.offset = _int(input) * 60;
      },
      o: function(date, padding) {___jdce_logger("/js/libs/lavaca.js", 814);
    ...
    zz: {
      exp: '[-+]?[0-1]\\d',
      i: function(input, dateObj, mappedObj) {___jdce_logger("/js/libs/lavaca.js", 815);
        DateUtils.fn.z.i(input, dateObj, mappedObj);
      },
      o: function(date) {___jdce_logger("/js/libs/lavaca.js", 816);
        return DateUtils.fn.z.o(date, 2);
      }
    },
    zzz: {
      exp: '[-+]?[0-1]\\d:\\d{2}',
      i: function(input, dateObj) {___jdce_logger("/js/libs/lavaca.js", 817);
        var parts = input.split(':');
        dateObj.offset = _int(parts[0]) * 60 + _int(parts[1]);
      },
      o: function(date) {___jdce_logger("/js/libs/lavaca.js", 818);
  ...
  function _parseFormat(f) {___jdce_logger("/js/libs/lavaca.js", 819);
    var actors = [],
        buffer = '',
        i = -1,
        bufferChar,
  ...
  function _actorsToRegex(actors) {___jdce_logger("/js/libs/lavaca.js", 820);
    var s = ['^'],
        i = -1,
        actor,
        handler;
   ...
   */
  DateUtils.parse = function(s, f) {___jdce_logger("/js/libs/lavaca.js", 821);
   ...
   * @return {String}  The stringified date
   */
  DateUtils.stringify = function(d, f, utc) {___jdce_logger("/js/libs/lavaca.js", 822);
    var actors = _parseFormat(f),
        i = -1,
        s = [],
        actor,
...
define('lavaca/util/Promise',['require','./extend'],function(require) {___jdce_logger("/js/libs/lavaca.js", 823);
   ...
   * @param {Object} thisp  What the "this" keyword resolves to in callbacks
   */
  var Promise = extend(function(thisp) {___jdce_logger("/js/libs/lavaca.js", 824);
    /**
     * What the "this" keyword resolves to in callbacks
     * @property {Object} thisp
     * @default null
     ...
     * @return {Lavaca.util.Promise}  This promise (for chaining)
     */
    success: function(callback) {___jdce_logger("/js/libs/lavaca.js", 825);
      if (callback) {
        if (this.succeeded) {
          callback.apply(this.thisp, this.resolveArgs);
        } else {
     ...
     * @return {Lavaca.util.Promise}  This promise (for chaining)
     */
    error: function(callback) {___jdce_logger("/js/libs/lavaca.js", 826);
      if (callback) {
        if (this.failed) {
          callback.apply(this.thisp, this.rejectArgs);
        } else {
     ...
     * @return {Lavaca.util.Promise}  This promise (for chaining)
     */
    always: function(callback) {___jdce_logger("/js/libs/lavaca.js", 827);
      return this.then(callback, callback);
    },
    /**
     * Queues up callbacks after the promise is completed
     ...
     * @return {Lavaca.util.Promise}  This promise (for chaining)
     */
    then: function(resolved, rejected) {___jdce_logger("/js/libs/lavaca.js", 828);
      return this
        .success(resolved)
        .error(rejected);
    },
     ...
     * @return {Lavaca.util.Promise}  This promise (for chaining)
     */
    resolve: function(/* value1, value2, valueN */) {___jdce_logger("/js/libs/lavaca.js", 829);
      if (!this.succeeded && !this.failed) {
        this.succeeded = true;
        this.resolveArgs = [].slice.call(arguments, 0);
        var i = -1,
     ...
     * @return {Lavaca.util.Promise}  This promise (for chaining)
     */
    reject: function(/* err1, err2, errN */) {___jdce_logger("/js/libs/lavaca.js", 830);
      if (!this.succeeded && !this.failed) {
        this.failed = true;
        this.rejectArgs = [].slice.call(arguments, 0);
        var i = -1,
     ...
     * @return {Lavaca.util.Promise}  This promise (for chaining)
     */
    when: function(/* promise1, promise2, promiseN */) {___jdce_logger("/js/libs/lavaca.js", 831);
      var self = this,
          values = [],
          i = -1,
          pendingPromiseCount = arguments.length,
          promise;
      while (!!(promise = arguments[++i])) {
        (function(index) {___jdce_logger("/js/libs/lavaca.js", 832);
          promise
            .success(function(v) {___jdce_logger("/js/libs/lavaca.js", 833);
              values[index] = v;
              if (--pendingPromiseCount < 1) {
                self.resolve.apply(self, values);
              }
            })
            .error(function() {___jdce_logger("/js/libs/lavaca.js", 834);
              self.reject.apply(self, arguments);
            });
        })(i);
      }
     ...
     * @return {Function}  The callback
     */
    resolver: function() {___jdce_logger("/js/libs/lavaca.js", 835);
      var self = this;
      return function() {___jdce_logger("/js/libs/lavaca.js", 836);
        self.resolve.apply(self, arguments);
      };
    },
    /**
     ...
     * @return {Function}  The callback
     */
    rejector: function() {___jdce_logger("/js/libs/lavaca.js", 837);
      var self = this;
      return function() {___jdce_logger("/js/libs/lavaca.js", 838);
        self.reject.apply(self, arguments);
      };
    }
  });
   ...
   * @return {Lavaca.util.Promise}  The new promise
   */
  Promise.when = function(thisp/*, promise1, promise2, promiseN */) {___jdce_logger("/js/libs/lavaca.js", 839);
    var thispIsPromise = thisp instanceof Promise,
        promise = new Promise(thispIsPromise ? window : thisp),
        args = [].slice.call(arguments, thispIsPromise ? 0 : 1);
    return promise.when.apply(promise, args);
...
define('lavaca/util/StringUtils',['require'],function(require) {___jdce_logger("/js/libs/lavaca.js", 840);
  ...
  function _noop(s) {___jdce_logger("/js/libs/lavaca.js", 841);
    return s;
  }
   ...
   * @return {String}  The format string with the arguments substituted into it
   */
  StringUtils.format = function(s /*[, arg0, arg1, argN]*/) {___jdce_logger("/js/libs/lavaca.js", 842);
    var args,
        fn = _noop,
        i,
        j;
   ...
   * @return {String}  The escaped string
   */
  StringUtils.escapeHTML = function(s) {___jdce_logger("/js/libs/lavaca.js", 843);
    s = '' + s;
    for (var n in _htmlEscapes) {
      s = s.split(n).join(_htmlEscapes[n]);
    }
...
define('lavaca/util/delay',[],function() {___jdce_logger("/js/libs/lavaca.js", 844);
  /**
   * Wraps setTimeout and delays the execution of a function
   * @class lavaca.util.delay
   */
   ...
   * @return {Number}  The timeout ID
   */
  var delay = function(callback, thisp, ms) {___jdce_logger("/js/libs/lavaca.js", 845);
    return setTimeout(function() {___jdce_logger("/js/libs/lavaca.js", 846);
      callback.call(thisp);
    }, ms || 0);
  };
...
define('lavaca/util/log',[],function() {___jdce_logger("/js/libs/lavaca.js", 847);
  /**
   * Logs to the console (or alerts if no console exists)
   * @class lavaca.util.log
   */
   ...
   * @params {Object} arg  The content to be logged
   */
  var log = function() {___jdce_logger("/js/libs/lavaca.js", 848);
    if (window.console) {
      console.log.apply(console, arguments);
    } else {
      alert([].join.call(arguments, ' '));
...
define('lavaca/util/resolve',[],function() {___jdce_logger("/js/libs/lavaca.js", 849);
  /**
   * Looks up or creates an object, given its global path (ie, 'Lavaca.resolve' resolves to this function,
   * 'no.obj.exists' resolves to null)
   * @class lavaca.util.resolve
   ...
   * @return {Object}  The resolved object
   */
  var resolve = function(name, createIfNotExists, root) {___jdce_logger("/js/libs/lavaca.js", 850);
    if (!name) {
      return null;
    }
    name = name.split('.');
...
define('lavaca/util/uuid',[],function() {___jdce_logger("/js/libs/lavaca.js", 851);
   ...
   * @return {Number}  A number that is unique to this page
   */
  var uuid = function(namespace) {___jdce_logger("/js/libs/lavaca.js", 852);
    namespace = namespace || '__defaultNS';
    if (typeof _uuidMap[namespace] !== 'number') {
      _uuidMap[namespace] = 0;
    }
