...
//"use strict"; don't restore this until the config routine is refactored
	...
	core = {
		...
		createContext: function (cfg, baseId, depNames, isPreload) {___jdce_logger("/bower_components/curl/src/curl.js", 28);
			...
			function toUrl(){___jdce_logger("/bower_components/curl/src/curl.js", 30);}

			function localRequire(){___jdce_logger("/bower_components/curl/src/curl.js", 31);}
		...
		createResourceDef: function (cfg, id, isPreload) {___jdce_logger("/bower_components/curl/src/curl.js", 32);
			...
			execute = countdown(1, function(){___jdce_logger("/bower_components/curl/src/curl.js", 33);});

			// intercept resolve function to execute definition function
			// before resolving
			def.resolve = function resolve (deps) {___jdce_logger("/bower_components/curl/src/curl.js", 34);
				when(isPreload || preload, function () {___jdce_logger("/bower_components/curl/src/curl.js", 35);
					origResolve((cache[def.id] = urlCache[def.url] = execute(deps)));
				});
			};

			// track exports
			def.exportsReady = function executeFactory (deps) {___jdce_logger("/bower_components/curl/src/curl.js", 36);
				when(isPreload || preload, function () {___jdce_logger("/bower_components/curl/src/curl.js", 37);
		...
		createPluginDef: function (cfg, id, resId, isPreload) {___jdce_logger("/bower_components/curl/src/curl.js", 38);
			var def;
		...
		getCjsRequire: function(){___jdce_logger("/bower_components/curl/src/curl.js", 39);},

		getCjsExports: function(){___jdce_logger("/bower_components/curl/src/curl.js", 40);},

		getCjsModule: function(){___jdce_logger("/bower_components/curl/src/curl.js", 41);},

		getDefUrl: function (def) {___jdce_logger("/bower_components/curl/src/curl.js", 42);
		 ...
		 */
		setApi: function (cfg) {___jdce_logger("/bower_components/curl/src/curl.js", 43);
			/*
			scenarios:
		...
		config: function (cfg) {___jdce_logger("/bower_components/curl/src/curl.js", 44);
			...
			function fixAndPushPaths (coll, isPkg) {___jdce_logger("/bower_components/curl/src/curl.js", 45);
			...
			function convertPathMatcher (cfg) {___jdce_logger("/bower_components/curl/src/curl.js", 46);
				var pathMap = cfg.pathMap;
				cfg.pathRx = new RegExp('^(' +
					cfg.pathList.sort(function (a, b) {___jdce_logger("/bower_components/curl/src/curl.js", 47); return pathMap[b].specificity - pathMap[a].specificity; } )
						.join('|')
						.replace(/\/|\./g, '\\$&') +
					')(?=\\/|$)'
				);
		...
		resolvePathInfo: function (absId, cfg) {___jdce_logger("/bower_components/curl/src/curl.js", 48);
			...
			if (!isAbsUrl(absId)) {
				path = absId.replace(cfg.pathRx, function (match) {___jdce_logger("/bower_components/curl/src/curl.js", 49);
		...
		resolveUrl: function (path, cfg) {___jdce_logger("/bower_components/curl/src/curl.js", 50);
			var baseUrl = cfg.baseUrl;
			return baseUrl && !isAbsUrl(path) ? joinPath(baseUrl, path) : path;
		},

		checkToAddJsExt: function (url, cfg) {___jdce_logger("/bower_components/curl/src/curl.js", 51);
		...
		loadScript: function (def, success, failure) {___jdce_logger("/bower_components/curl/src/curl.js", 52);
			...
			function process(){___jdce_logger("/bower_components/curl/src/curl.js", 53);}

			function fail(){___jdce_logger("/bower_components/curl/src/curl.js", 54);}
		...
		extractCjsDeps: function(){___jdce_logger("/bower_components/curl/src/curl.js", 55);},

		fixArgs: function(){___jdce_logger("/bower_components/curl/src/curl.js", 56);},

		executeDefFunc: function(){___jdce_logger("/bower_components/curl/src/curl.js", 57);},

		defineResource: function(){___jdce_logger("/bower_components/curl/src/curl.js", 58);},

		getDeps: function (parentDef) {___jdce_logger("/bower_components/curl/src/curl.js", 59);
			...
			function collect(){___jdce_logger("/bower_components/curl/src/curl.js", 60);}
			...
			function getDep (name, index) {___jdce_logger("/bower_components/curl/src/curl.js", 61);
				var resolveOnce, exportOnce, childDef, earlyExport;

				resolveOnce = countdown(1, function(){___jdce_logger("/bower_components/curl/src/curl.js", 62);});
				exportOnce = countdown(1, function(){___jdce_logger("/bower_components/curl/src/curl.js", 63);});
				...
				when(childDef,
					resolveOnce,
					parentDef.reject,
					parentDef.exports && function(){___jdce_logger("/bower_components/curl/src/curl.js", 64);}
				);
			}

			function allResolved () {___jdce_logger("/bower_components/curl/src/curl.js", 65);
				parentDef.resolve(deps);
			}

			function allExportsReady () {___jdce_logger("/bower_components/curl/src/curl.js", 66);
				parentDef.exportsReady && parentDef.exportsReady(deps);
			}

		},

		fetchResDef: function (def) {___jdce_logger("/bower_components/curl/src/curl.js", 67);
			...
			core.loadScript(def,
				...
				function(){___jdce_logger("/bower_components/curl/src/curl.js", 68);},
		...
		fetchDep: function (depName, parentDef) {___jdce_logger("/bower_components/curl/src/curl.js", 69);
			...
			if (mainId == loaderId) {
				...
				when(def, function(plugin) {___jdce_logger("/bower_components/curl/src/curl.js", 70);
					...
					if (!(fullId in cache)) {
						...
						var loaded = function(){___jdce_logger("/bower_components/curl/src/curl.js", 71);};
		...
		getCurrentDefName: function(){___jdce_logger("/bower_components/curl/src/curl.js", 72);},

		findScript: function (predicate) {___jdce_logger("/bower_components/curl/src/curl.js", 73);
			var i = 0, script;
		...
		extractDataAttrConfig: function (cfg) {___jdce_logger("/bower_components/curl/src/curl.js", 74);
			var script;
			script = core.findScript(function (script) {___jdce_logger("/bower_components/curl/src/curl.js", 75);
				var main;
		...
		nextTurn: function (task) {___jdce_logger("/bower_components/curl/src/curl.js", 76);
			setTimeout(task, 0);
		}
	...
	function _curl(){___jdce_logger("/bower_components/curl/src/curl.js", 77);}

	function _config (cfg, callback, errback) {___jdce_logger("/bower_components/curl/src/curl.js", 78);
		...
		if (cfg) {
			...
			if ('preloads' in cfg) {
				...
				core.nextTurn(function(){___jdce_logger("/bower_components/curl/src/curl.js", 79);});
			}
			...
			if (main) {
				...
				fallback = main[1]
					? function () {___jdce_logger("/bower_components/curl/src/curl.js", 80); new CurlApi(main[1], mPromise.resolve, mPromise.reject); }
					: mPromise.reject;
	...
	function CurlApi (ids, callback, errback, waitFor, isPreload) {___jdce_logger("/bower_components/curl/src/curl.js", 81);
		var then, ctx;

		ctx = core.createContext(userCfg, undef, [].concat(ids), isPreload);

		this['then'] = this.then = then = function (resolved, rejected) {___jdce_logger("/bower_components/curl/src/curl.js", 82);
			when(ctx,
				// return the dependencies as arguments, not an array
				function (deps) {___jdce_logger("/bower_components/curl/src/curl.js", 83);
					if (resolved) resolved.apply(undef, deps);
				},
				// just throw if the dev didn't specify an error handler
				function (ex) {___jdce_logger("/bower_components/curl/src/curl.js", 84);
		...
		this['next'] = function(){___jdce_logger("/bower_components/curl/src/curl.js", 85);};
		...
		core.nextTurn(function(){___jdce_logger("/bower_components/curl/src/curl.js", 86);});
	}

	_curl['version'] = version;
	_curl['config'] = _config;

	function _define(){___jdce_logger("/bower_components/curl/src/curl.js", 87);}

	function define(){___jdce_logger("/bower_components/curl/src/curl.js", 88);}
	...
	cache['curl/_privileged'] = {
		'core': core,
		'cache': cache,
		'config': function () {___jdce_logger("/bower_components/curl/src/curl.js", 89); return userCfg; },
		'_define': _define,
		'_curl': _curl,
		'Promise': Promise
	};
