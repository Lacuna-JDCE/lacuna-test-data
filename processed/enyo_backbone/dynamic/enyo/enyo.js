(function() {___jdce_logger("/enyo/enyo.js", 0);
	// enyo can use information from the script tag that loads this bootstrap file
	var thisScript = 'enyo.js';

	enyo = window.enyo || {};

	enyo.locateScript = function(inName) {___jdce_logger("/enyo/enyo.js", 1);
	...
	var script = function(inSrc) {___jdce_logger("/enyo/enyo.js", 2);
