...
(function (factory) {___jdce_logger("/node_modules/backbone.nativeview/backbone.nativeview.js", 0);
  ...
  var elementAddEventListener = ElementProto.addEventListener || function(eventName, listener) {___jdce_logger("/node_modules/backbone.nativeview/backbone.nativeview.js", 2);
    return this.attachEvent('on' + eventName, listener);
  }
  var elementRemoveEventListener = ElementProto.removeEventListener || function(eventName, listener) {___jdce_logger("/node_modules/backbone.nativeview/backbone.nativeview.js", 3);
    return this.detachEvent('on' + eventName, listener);
  }

  var indexOf = function(array, item) {___jdce_logger("/node_modules/backbone.nativeview/backbone.nativeview.js", 4);
  ...
  var matchesSelector = ElementProto.matches ||
      ...
      function(selector) {___jdce_logger("/node_modules/backbone.nativeview/backbone.nativeview.js", 5);
  ...
  Backbone.NativeViewMixin = {
    ...
    delegate: function(eventName, selector, listener) {___jdce_logger("/node_modules/backbone.nativeview/backbone.nativeview.js", 11);
      ...
      var root = this.el;
      var handler = selector ? function (e) {___jdce_logger("/node_modules/backbone.nativeview/backbone.nativeview.js", 12);
    ...
    undelegate: function(eventName, selector, listener) {___jdce_logger("/node_modules/backbone.nativeview/backbone.nativeview.js", 13);
      if (typeof selector === 'function') {
        listener = selector;
        selector = null;
      }
