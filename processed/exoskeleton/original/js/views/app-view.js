...
(function () {___jdce_logger("/js/views/app-view.js", 0);
	...
	app.AppView = Backbone.View.extend({
		...
		addOne: function (todo) {___jdce_logger("/js/views/app-view.js", 7);
		...
		filterOne: function (todo) {___jdce_logger("/js/views/app-view.js", 9);
		...
		createOnEnter: function (e) {___jdce_logger("/js/views/app-view.js", 12);
		...
		clearCompleted: function () {___jdce_logger("/js/views/app-view.js", 13);
			app.todos.completed().forEach(function (todo) {___jdce_logger("/js/views/app-view.js", 14);
				todo.destroy();
			});
			return false;
		},

		toggleAllComplete: function () {___jdce_logger("/js/views/app-view.js", 15);
			var completed = this.allCheckbox.checked;

			app.todos.forEach(function (todo) {___jdce_logger("/js/views/app-view.js", 16);
				todo.save({
					'completed': completed
				});
			});
