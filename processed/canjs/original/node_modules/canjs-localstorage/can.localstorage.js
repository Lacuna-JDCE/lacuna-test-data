  ...
  define(['can/model'], function(Model) {___jdce_logger("/node_modules/canjs-localstorage/can.localstorage.js", 2);
    return Model.extend({
      ...
      destroy: function(id) {___jdce_logger("/node_modules/canjs-localstorage/can.localstorage.js", 8);
        var def = new can.Deferred();
        this.localStore(function(todos) {___jdce_logger("/node_modules/canjs-localstorage/can.localstorage.js", 9);
      ...
      create: function(attrs) {___jdce_logger("/node_modules/canjs-localstorage/can.localstorage.js", 10);
        var def = new can.Deferred();
        this.localStore(function(todos) {___jdce_logger("/node_modules/canjs-localstorage/can.localstorage.js", 11);
      ...
      update: function(id, attrs) {___jdce_logger("/node_modules/canjs-localstorage/can.localstorage.js", 12);
        var def = new can.Deferred(), todo;
        this.localStore(function(todos) {___jdce_logger("/node_modules/canjs-localstorage/can.localstorage.js", 13);
          for (var i = 0; i < todos.length; i++) {
            if (todos[i].id === id) {
              todo = todos[i];
              break;
