...
app.watchInput = function (onenter, onescape) {___jdce_logger("/js/views/main-view.js", 0);
	return function (e) {___jdce_logger("/js/views/main-view.js", 1);
					...
					ctrl.list.filter(ctrl.isVisible.bind(ctrl)).map(function (task, index) {___jdce_logger("/js/views/main-view.js", 5);
						...
						key: task.key
							...
							m('.view', [
								...
								oninput: m.withAttr('value', function (value) {___jdce_logger("/js/views/main-view.js", 7);
									m.redraw.strategy('none');
									task.title(value);
								}),
								config: function (element) {___jdce_logger("/js/views/main-view.js", 8);
									if (task.editing()) {
										element.focus();
									}
								},
