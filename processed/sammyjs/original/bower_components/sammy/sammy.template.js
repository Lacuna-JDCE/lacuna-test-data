(function (factory) {___jdce_logger("/bower_components/sammy/sammy.template.js", 0);
  ...
  var srender_cache = {};
  var srender = function(name, template, data, options) {___jdce_logger("/bower_components/sammy/sammy.template.js", 2);
  ...
  //       });
  //
  Sammy.Template = function(app, method_alias) {___jdce_logger("/bower_components/sammy/sammy.template.js", 3);
    ...
    //
    var template = function(template, data, name, options) {___jdce_logger("/bower_components/sammy/sammy.template.js", 4);
